...
VERSION_TABLE = {
    ...
    "oot-ntsc-1.0": GameVersionInfo(
        GameVersion.OOT_NTSC_1_0, MMLVersion.OOT, 0x0D390, 0x29DE0, 0x79470, 0xB896A0, 0xB89910, 0xB89AD0, 0xB8A1C0
    ),
    ...
    "oot-gc-us": GameVersionInfo(
        GameVersion.OOT_GC_US, MMLVersion.OOT, 0x0D0C0, 0x38E80, 0x88900, 0xB87DA0, 0xB88010, 0xB881D0, 0xB888C0
    ),
    # "oot-gc-us-mq"      :   GameVersionInfo(GameVersion.OOT_GC_US_MQ, MMLVersion.OOT,
    "oot-gc-eu": GameVersionInfo(
        GameVersion.OOT_GC_EU, MMLVersion.OOT, 0x0D0D0, 0x38E90, 0x88910, 0xB87590, 0xB87800, 0xB879C0, 0xB880B0
    ),
    ...
    "oot-gc-eu-mq": GameVersionInfo(
        GameVersion.OOT_GC_EU_MQ, MMLVersion.OOT, 0x0D0D0, 0x38E90, 0x88910, 0xB87570, 0xB877E0, 0xB879A0, 0xB88090
    ),
    "oot-gc-eu-mq-dbg": GameVersionInfo(
        GameVersion.OOT_GC_EU_MQ_DBG, MMLVersion.OOT, 0x19030, 0x44DF0, 0x94870, 0xBCC270, 0xBCC4E0, 0xBCC6A0, 0xBCCD90
    ),
    ...
    # MM
    "mm-n64-jp-1.0": GameVersionInfo(
        GameVersion.MM_N64_JP_1_0, MMLVersion.MM, 0x222F0, 0x48160, 0x995D0, 0xC97130, 0xC973C0, 0xC975D0, 0xC97DE0
    ),
    # "mm-n64-jp-1.1"         GameVersionInfo(GameVersion.MM_N64_JP_1_1, MMLVersion.MM,
    "mm-n64-us": GameVersionInfo(
        GameVersion.MM_N64_US, MMLVersion.MM, 0x20700, 0x46AF0, 0x97F70, 0xC776C0, 0xC77960, 0xC77B70, 0xC78380
    ),
    ...
    "mm-n64-eu-1.1-dbg": GameVersionInfo(
        GameVersion.MM_N64_EU_1_1_DBG, MMLVersion.MM, 0x2B2D0, 0x516C0, 0xA2B40, 0xE0F7E0, 0xE0FA80, 0xE0FC90, 0xE104A0
    ),
