...
#define SET_TEXTTRIGGERFLAGS(v_) (gSaveContext.textTriggerFlags = (v_))
...
#define SET_INVENTORY_EQUIPMENT(v_) (gSaveContext.save.info.inventory.equipment = (v_))
#define GET_INVENTORY_QUESTITEMS gSaveContext.save.info.inventory.questItems
#define SET_INVENTORY_QUESTITEMS(v_) (gSaveContext.save.info.inventory.questItems = (v_))
...
#define SET_INVENTORY_DUNGEONITEMS_A0(a0_, v_) (gSaveContext.save.info.inventory.dungeonItems[a0_] = (v_))
...
#define GET_INVENTORY_UPGRADES gSaveContext.save.info.inventory.upgrades
#define SET_INVENTORY_UPGRADES(v_) (gSaveContext.save.info.inventory.upgrades = (v_))
...
#define SET_SCENEFLAGS_A0_ROOMS(a0_, v_) (gSaveContext.save.info.sceneFlags[a0_].rooms = (v_))
...
#define SET_SCENEFLAGS_A0_FLOORS(a0_, v_) (gSaveContext.save.info.sceneFlags[a0_].floors = (v_))
...
#define SET_WORLDMAPAREADATA(v_) (gSaveContext.save.info.worldMapAreaData = (v_))
...
#define SET_ITEMGETINF_A0(a0_, v_) (gSaveContext.save.info.itemGetInf[a0_] = (v_))
