    ...
    /* Sprite immediate macros, there is also a sprite dma macro above */
         ...
         */
            ...
            #define __gsSP1Triangle_w1f(v0, v1, v2, flag)                                                        \
                (((flag) == 0) ? __gsSP1Triangle_w1(v0, v1, v2) : ((flag) == 1) ? __gsSP1Triangle_w1(v1, v2, v0) \
            ...
            #define __gsSPLine3D_w1f(v0, v1, wd, flag) \
                (((flag) == 0) ? __gsSPLine3D_w1(v0, v1, wd) : __gsSPLine3D_w1(v1, v0, wd))

            #define __gsSP1Quadrangle_w1f(v0, v1, v2, v3, flag)                                                  \
                (((flag) == 0) ? __gsSP1Triangle_w1(v0, v1, v2) : ((flag) == 1) ? __gsSP1Triangle_w1(v1, v2, v3) \
                                                              : ((flag) == 2)   ? __gsSP1Triangle_w1(v2, v3, v0) \
                                                                                : __gsSP1Triangle_w1(v3, v0, v1))

            #define __gsSP1Quadrangle_w2f(v0, v1, v2, v3, flag)                                                  \
                (((flag) == 0) ? __gsSP1Triangle_w1(v0, v2, v3) : ((flag) == 1) ? __gsSP1Triangle_w1(v1, v3, v0) \
         ...
         */
            ...
            #define G_DEPTOZSrg(zval, near, far, flag, zmin, zmax)                                         \
                (((unsigned int)FTOFIX32(((flag) == G_BZ_PERSP ? (1.0f - (float)(near) / (float)(zval)) /  \
    ...
    /* The S at the end means odd lines are already word Swapped */
        ...
        #define gSPScisTextureRectangle(pkt, xl, yl, xh, yh, tile, s, t, dsdx, dtdy)                                                                                     \
            _DW({                                                                                                                                                        \
                ...
                gImmp1(pkt, G_RDPHALF_1,                                                                                                                                 \
                       (_SHIFTL(((s) -                                                                                                                                   \
                                 (((s16)(xl) < 0) ? (((s16)(dsdx) < 0) ? (MAX((((s16)(xl) * (s16)(dsdx)) >> 7), 0)) : (MIN((((s16)(xl) * (s16)(dsdx)) >> 7), 0))) : 0)), \
                                16, 16) |                                                                                                                                \
                        _SHIFTL(((t) -                                                                                                                                   \
                                 (((yl) < 0) ? (((s16)(dtdy) < 0) ? (MAX((((s16)(yl) * (s16)(dtdy)) >> 7), 0)) : (MIN((((s16)(yl) * (s16)(dtdy)) >> 7), 0))) : 0)),      \
                                0, 16)));                                                                                                                                \
                gImmp1(pkt, G_RDPHALF_2,                                                                                                                                 \
                       (_SHIFTL((dsdx), 16, 16) |                                                                                                                        \
                        _SHIFTL((dtdy), 0, 16)));                                                                                                                        \
