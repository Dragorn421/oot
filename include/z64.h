...
typedef struct {
    ...
    /* 0x40 */ f32 naviRefPosScale_40__;
    /* 0x44 */ f32 entryRadiusIni_44_;
    /* 0x48 */ s16 alpha_48_;
    /* 0x4A */ u8 activeCategory;
    /* 0x4B */ u8 zTargetRot_4B_;
    /* 0x4C */ s8 firstEntryIndex_4C_;
    /* 0x50 */ TargetContextEntry markerEntries_50_[3];
    /* 0x8C */ Actor* unusedAlwaysNULL_8C;
    /* 0x90 */ Actor* bgmEnemy; // The nearest enemy to player with the right flags that will trigger NA_BGM_ENEMY
    /* 0x94 */ Actor* targetActor_ReallyISwear_94_;
