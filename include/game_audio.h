...
#define AUDIO_RELOCATED_ADDRESS_START (u32)KSEG0_START_ADDR
...
typedef struct AudioAsyncLoad {
    ...
    struct dma_request req; // TODO-ootdragon replaces various queues. idk if applicable here
...
void AudioLoad_AsyncLoadSeq(s32 seqId, s32 arg1, s32 retData, struct dma_request* req);
void AudioLoad_AsyncLoadSampleBank(s32 sampleBankId, s32 arg1, s32 retData, struct dma_request* req);
void AudioLoad_AsyncLoadFont(s32 fontId, s32 arg1, s32 retData, struct dma_request* req);
...
void Audio_PlaySwordChargeSfx(Vec3f*, u8);
