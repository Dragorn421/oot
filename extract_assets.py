...
def ExtractFile(xmlPath, outputPath, outputSourcePath):
    ...
    execStr = "tools/ZAPD/ZAPD.out e -eh -i %s -b extracted/gc-eu-mq-dbg/baserom -o %s -osf %s -gsf 1 -rconf tools/ZAPDConfigs/MqDbg/Config.xml --cs-float both" % (xmlPath, outputPath, outputSourcePath)
