...
void KaleidoScope_DrawAmmoCount(PauseContext* pauseCtx, GraphicsContext* gfxCtx, s16 item) {
    ...
    if (!((gSlotAgeReqs[SLOT(item)] == 9) || gSlotAgeReqs[SLOT(item)] == (GET_LINKAGE_VOID0))) {
...
void KaleidoScope_DrawItemSelect(PlayState* play) {
        ...
        if (pauseCtx->cursorSpecialPos == 0) {
            ...
            if (ABS(pauseCtx->stickAdjX) > 30) {
                ...
                if (moveCursorResult == 1) {
                    cursorItem = GET_INVENTORY_ITEMS[pauseCtx->cursorPoint[PAUSE_ITEM]];
                }
            ...
            if (pauseCtx->stickAdjX > 30) {
                ...
                while (true) {
                    if (GET_INVENTORY_ITEMS_A0(cursorPoint) != ITEM_NONE) {
                        pauseCtx->cursorPoint[PAUSE_ITEM] = cursorPoint;
                        pauseCtx->cursorX[PAUSE_ITEM] = cursorX;
    ...
    for (i = j = 0; i < 24; i++, j += 4) {
        ...
        if (GET_INVENTORY_ITEMS_A0(i) != ITEM_NONE) {
            if ((pauseCtx->unk_1E4 == 0) && (pauseCtx->pageIndex == PAUSE_ITEM) && (pauseCtx->cursorSpecialPos == 0)) {
                if ((gSlotAgeReqs[i] == 9) || (gSlotAgeReqs[i] == (GET_LINKAGE_VOID0))) {
    ...
    for (i = 0; i < 15; i++) {
        if ((gAmmoItems[i] != ITEM_NONE) && (GET_INVENTORY_ITEMS_A0(i) != ITEM_NONE)) {
            KaleidoScope_DrawAmmoCount(pauseCtx, play->state.gfxCtx, GET_INVENTORY_ITEMS_A0(i));
        }
    }
    ...
    if (sEquipAnimTimer == 0) {
        ...
        if (sEquipMoveTimer == 0) {
            ...
            if (pauseCtx->equipTargetCBtn == 0) {
                ...
                if (pauseCtx->equipTargetSlot == GET_EQUIPS_CBUTTONSLOTS_A0(1)) {
                    if (GET_EQUIPS_BUTTONITEMS_A0(1) != ITEM_NONE) {
                        if ((pauseCtx->equipTargetItem >= 0xBF) && (pauseCtx->equipTargetItem <= 0xC1) &&
                            ((GET_EQUIPS_BUTTONITEMS_A0(1) == ITEM_BOW) ||
                             ((GET_EQUIPS_BUTTONITEMS_A0(1) >= ITEM_BOW_ARROW_FIRE) &&
                              (GET_EQUIPS_BUTTONITEMS_A0(1) <= ITEM_BOW_ARROW_LIGHT)))) {
                            pauseCtx->equipTargetItem -= 0xBF - ITEM_BOW_ARROW_FIRE;
                            pauseCtx->equipTargetSlot = SLOT_BOW;
                        } else {
                            SET_EQUIPS_BUTTONITEMS_A0(2, GET_EQUIPS_BUTTONITEMS_A0(1));
                            SET_EQUIPS_CBUTTONSLOTS_A0(1, GET_EQUIPS_CBUTTONSLOTS_A0(0));
                            Interface_LoadItemIcon2(play, 2);
                        }
                    } else {
                        SET_EQUIPS_BUTTONITEMS_A0(2, ITEM_NONE);
                        SET_EQUIPS_CBUTTONSLOTS_A0(1, SLOT_NONE);
                    }
                } else if (pauseCtx->equipTargetSlot == GET_EQUIPS_CBUTTONSLOTS_A0(2)) {
                    if (GET_EQUIPS_BUTTONITEMS_A0(1) != ITEM_NONE) {
                        if ((pauseCtx->equipTargetItem >= 0xBF) && (pauseCtx->equipTargetItem <= 0xC1) &&
                            ((GET_EQUIPS_BUTTONITEMS_A0(1) == ITEM_BOW) ||
                             ((GET_EQUIPS_BUTTONITEMS_A0(1) >= ITEM_BOW_ARROW_FIRE) &&
                            ...
                            SET_EQUIPS_BUTTONITEMS_A0(3, GET_EQUIPS_BUTTONITEMS_A0(1));
                            SET_EQUIPS_CBUTTONSLOTS_A0(2, GET_EQUIPS_CBUTTONSLOTS_A0(0));
                            Interface_LoadItemIcon2(play, 3);
                        }
                    } else {
                        SET_EQUIPS_BUTTONITEMS_A0(3, ITEM_NONE);
                        SET_EQUIPS_CBUTTONSLOTS_A0(2, SLOT_NONE);
                    }
                }

                if ((pauseCtx->equipTargetItem >= 0xBF) && (pauseCtx->equipTargetItem <= 0xC1)) {
                    if ((GET_EQUIPS_BUTTONITEMS_A0(1) == ITEM_BOW) ||
                        ((GET_EQUIPS_BUTTONITEMS_A0(1) >= ITEM_BOW_ARROW_FIRE) &&
                         (GET_EQUIPS_BUTTONITEMS_A0(1) <= ITEM_BOW_ARROW_LIGHT))) {
                        pauseCtx->equipTargetItem -= 0xBF - ITEM_BOW_ARROW_FIRE;
                        pauseCtx->equipTargetSlot = SLOT_BOW;
                    ...
                    if ((GET_EQUIPS_BUTTONITEMS_A0(2) >= ITEM_BOW_ARROW_FIRE) &&
                        (GET_EQUIPS_BUTTONITEMS_A0(2) <= ITEM_BOW_ARROW_LIGHT)) {
                        SET_EQUIPS_BUTTONITEMS_A0(2, GET_EQUIPS_BUTTONITEMS_A0(1));
                        SET_EQUIPS_CBUTTONSLOTS_A0(1, GET_EQUIPS_CBUTTONSLOTS_A0(0));
                        Interface_LoadItemIcon2(play, 2);
                    } else if ((GET_EQUIPS_BUTTONITEMS_A0(3) >= ITEM_BOW_ARROW_FIRE) &&
                               (GET_EQUIPS_BUTTONITEMS_A0(3) <= ITEM_BOW_ARROW_LIGHT)) {
                        SET_EQUIPS_BUTTONITEMS_A0(3, GET_EQUIPS_BUTTONITEMS_A0(1));
                        SET_EQUIPS_CBUTTONSLOTS_A0(2, GET_EQUIPS_CBUTTONSLOTS_A0(0));
                        Interface_LoadItemIcon2(play, 3);
                    }
                ...
                SET_EQUIPS_BUTTONITEMS_A0(1, pauseCtx->equipTargetItem);
                SET_EQUIPS_CBUTTONSLOTS_A0(0, pauseCtx->equipTargetSlot);
                ...
                if (pauseCtx->equipTargetSlot == GET_EQUIPS_CBUTTONSLOTS_A0(0)) {
                    if (GET_EQUIPS_BUTTONITEMS_A0(2) != ITEM_NONE) {
                        if ((pauseCtx->equipTargetItem >= 0xBF) && (pauseCtx->equipTargetItem <= 0xC1) &&
                            ((GET_EQUIPS_BUTTONITEMS_A0(2) == ITEM_BOW) ||
                             ((GET_EQUIPS_BUTTONITEMS_A0(2) >= ITEM_BOW_ARROW_FIRE) &&
                              (GET_EQUIPS_BUTTONITEMS_A0(2) <= ITEM_BOW_ARROW_LIGHT)))) {
                            pauseCtx->equipTargetItem -= 0xBF - ITEM_BOW_ARROW_FIRE;
                            pauseCtx->equipTargetSlot = SLOT_BOW;
                        } else {
                            SET_EQUIPS_BUTTONITEMS_A0(1, GET_EQUIPS_BUTTONITEMS_A0(2));
                            SET_EQUIPS_CBUTTONSLOTS_A0(0, GET_EQUIPS_CBUTTONSLOTS_A0(1));
                            Interface_LoadItemIcon2(play, 1);
                        }
                    } else {
                        SET_EQUIPS_BUTTONITEMS_A0(1, ITEM_NONE);
                        SET_EQUIPS_CBUTTONSLOTS_A0(0, SLOT_NONE);
                    }
                } else if (pauseCtx->equipTargetSlot == GET_EQUIPS_CBUTTONSLOTS_A0(2)) {
                    if (GET_EQUIPS_BUTTONITEMS_A0(2) != ITEM_NONE) {
                        if ((pauseCtx->equipTargetItem >= 0xBF) && (pauseCtx->equipTargetItem <= 0xC1) &&
                            ...
                            SET_EQUIPS_BUTTONITEMS_A0(3, GET_EQUIPS_BUTTONITEMS_A0(2));
                            SET_EQUIPS_CBUTTONSLOTS_A0(2, GET_EQUIPS_CBUTTONSLOTS_A0(1));
                            Interface_LoadItemIcon2(play, 3);
                        }
                    } else {
                        SET_EQUIPS_BUTTONITEMS_A0(3, ITEM_NONE);
                ...
                if ((pauseCtx->equipTargetItem >= 0xBF) && (pauseCtx->equipTargetItem <= 0xC1)) {
                    if ((GET_EQUIPS_BUTTONITEMS_A0(2) == ITEM_BOW) ||
                        ((GET_EQUIPS_BUTTONITEMS_A0(2) >= ITEM_BOW_ARROW_FIRE) &&
                         (GET_EQUIPS_BUTTONITEMS_A0(2) <= ITEM_BOW_ARROW_LIGHT))) {
                        pauseCtx->equipTargetItem -= 0xBF - ITEM_BOW_ARROW_FIRE;
                        pauseCtx->equipTargetSlot = SLOT_BOW;
                    ...
                    if ((GET_EQUIPS_BUTTONITEMS_A0(1) >= ITEM_BOW_ARROW_FIRE) &&
                        (GET_EQUIPS_BUTTONITEMS_A0(1) <= ITEM_BOW_ARROW_LIGHT)) {
                        SET_EQUIPS_BUTTONITEMS_A0(1, GET_EQUIPS_BUTTONITEMS_A0(2));
                        Interface_LoadItemIcon2(play, 1);
                    } else if ((GET_EQUIPS_BUTTONITEMS_A0(3) >= ITEM_BOW_ARROW_FIRE) &&
                ...
                SET_EQUIPS_BUTTONITEMS_A0(2, pauseCtx->equipTargetItem);
                SET_EQUIPS_CBUTTONSLOTS_A0(1, pauseCtx->equipTargetSlot);
                ...
                if (pauseCtx->equipTargetSlot == GET_EQUIPS_CBUTTONSLOTS_A0(0)) {
                    if (GET_EQUIPS_BUTTONITEMS_A0(3) != ITEM_NONE) {
                        if ((pauseCtx->equipTargetItem >= 0xBF) && (pauseCtx->equipTargetItem <= 0xC1) &&
                            ((GET_EQUIPS_BUTTONITEMS_A0(3) == ITEM_BOW) ||
                             ((GET_EQUIPS_BUTTONITEMS_A0(3) >= ITEM_BOW_ARROW_FIRE) &&
                              (GET_EQUIPS_BUTTONITEMS_A0(3) <= ITEM_BOW_ARROW_LIGHT)))) {
                            pauseCtx->equipTargetItem -= 0xBF - ITEM_BOW_ARROW_FIRE;
                            pauseCtx->equipTargetSlot = SLOT_BOW;
                        } else {
                            SET_EQUIPS_BUTTONITEMS_A0(1, GET_EQUIPS_BUTTONITEMS_A0(3));
                            SET_EQUIPS_CBUTTONSLOTS_A0(0, GET_EQUIPS_CBUTTONSLOTS_A0(2));
                            Interface_LoadItemIcon2(play, 1);
                        }
                    } else {
                        SET_EQUIPS_BUTTONITEMS_A0(1, ITEM_NONE);
                ...
                } else if (pauseCtx->equipTargetSlot == GET_EQUIPS_CBUTTONSLOTS_A0(1)) {
                    if (GET_EQUIPS_BUTTONITEMS_A0(3) != ITEM_NONE) {
                        if ((pauseCtx->equipTargetItem >= 0xBF) && (pauseCtx->equipTargetItem <= 0xC1) &&
                            ((GET_EQUIPS_BUTTONITEMS_A0(3) == ITEM_BOW) ||
                             ((GET_EQUIPS_BUTTONITEMS_A0(3) >= ITEM_BOW_ARROW_FIRE) &&
                            ...
                            SET_EQUIPS_BUTTONITEMS_A0(2, GET_EQUIPS_BUTTONITEMS_A0(3));
                            SET_EQUIPS_CBUTTONSLOTS_A0(1, GET_EQUIPS_CBUTTONSLOTS_A0(2));
                            Interface_LoadItemIcon2(play, 2);
                        }
                    } else {
                        SET_EQUIPS_BUTTONITEMS_A0(2, ITEM_NONE);
                ...
                if ((pauseCtx->equipTargetItem >= 0xBF) && (pauseCtx->equipTargetItem <= 0xC1)) {
                    if ((GET_EQUIPS_BUTTONITEMS_A0(3) == ITEM_BOW) ||
                        ((GET_EQUIPS_BUTTONITEMS_A0(3) >= ITEM_BOW_ARROW_FIRE) &&
                         (GET_EQUIPS_BUTTONITEMS_A0(3) <= ITEM_BOW_ARROW_LIGHT))) {
                        pauseCtx->equipTargetItem -= 0xBF - ITEM_BOW_ARROW_FIRE;
                        pauseCtx->equipTargetSlot = SLOT_BOW;
                    ...
                    if ((GET_EQUIPS_BUTTONITEMS_A0(1) >= ITEM_BOW_ARROW_FIRE) &&
                        ...
                        SET_EQUIPS_BUTTONITEMS_A0(1, GET_EQUIPS_BUTTONITEMS_A0(3));
                        Interface_LoadItemIcon2(play, 1);
                    } else if ((GET_EQUIPS_BUTTONITEMS_A0(2) >= ITEM_BOW_ARROW_FIRE) &&
                               (GET_EQUIPS_BUTTONITEMS_A0(2) <= ITEM_BOW_ARROW_LIGHT)) {
                        SET_EQUIPS_BUTTONITEMS_A0(2, GET_EQUIPS_BUTTONITEMS_A0(3));
                        Interface_LoadItemIcon2(play, 2);
                    }
                ...
                SET_EQUIPS_BUTTONITEMS_A0(3, pauseCtx->equipTargetItem);
                SET_EQUIPS_CBUTTONSLOTS_A0(2, pauseCtx->equipTargetSlot);
