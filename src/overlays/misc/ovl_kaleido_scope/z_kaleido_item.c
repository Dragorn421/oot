...
void KaleidoScope_DrawAmmoCount(PauseContext* pauseCtx, GraphicsContext* gfxCtx, s16 item) {
    ...
    if (!((gSlotAgeReqs[SLOT(item)] == 9) || gSlotAgeReqs[SLOT(item)] == (GET_LINK_AGE_VOID0))) {
...
void KaleidoScope_DrawItemSelect(PlayState* play) {
    ...
    if ((pauseCtx->state == 6) && (pauseCtx->unk_1E4 == 0) && (pauseCtx->pageIndex == PAUSE_ITEM)) {
        ...
        if (pauseCtx->cursorSpecialPos == 0) {
            ...
            if (pauseCtx->stickAdjX > 30) {
                ...
                while (true) {
                    if (GET_INVENTORY_ITEMS[cursorPoint] != ITEM_NONE) {
                        pauseCtx->cursorPoint[PAUSE_ITEM] = cursorPoint;
                        pauseCtx->cursorX[PAUSE_ITEM] = cursorX;
        ...
        if (pauseCtx->cursorSpecialPos == 0) {
            ...
            if (!((gSlotAgeReqs[cursorSlot] == 9) ||
                  (gSlotAgeReqs[cursorSlot] == (GET_LINK_AGE_VOID0)))) {
    ...
    for (i = 0, j = 24 * 4; i < 3; i++, j += 4) {
        if (GET_EQUIPS_BUTTON_ITEMS[i + 1] != ITEM_NONE) {
    ...
    for (i = j = 0; i < 24; i++, j += 4) {
        ...
        if (GET_INVENTORY_ITEMS[i] != ITEM_NONE) {
            if ((pauseCtx->unk_1E4 == 0) && (pauseCtx->pageIndex == PAUSE_ITEM) && (pauseCtx->cursorSpecialPos == 0)) {
                if ((gSlotAgeReqs[i] == 9) || (gSlotAgeReqs[i] == (GET_LINK_AGE_VOID0))) {
            ...
            KaleidoScope_DrawQuadTextureRGBA32(play->state.gfxCtx,
                                               gItemIcons[GET_INVENTORY_ITEMS[i]], 32, 32, 0);
        }
    }
    ...
    for (i = 0; i < 15; i++) {
        if ((gAmmoItems[i] != ITEM_NONE) && (GET_INVENTORY_ITEMS[i] != ITEM_NONE)) {
            KaleidoScope_DrawAmmoCount(pauseCtx, play->state.gfxCtx, GET_INVENTORY_ITEMS[i]);
        }
    }
    ...
    if (sEquipAnimTimer == 0) {
        ...
        if (sEquipMoveTimer == 0) {
            ...
            if (pauseCtx->equipTargetCBtn == 0) {
                ...
                if (pauseCtx->equipTargetSlot == GET_EQUIPS_C_BUTTON_SLOTS[1]) {
                    if (GET_EQUIPS_BUTTON_ITEMS[1] != ITEM_NONE) {
                        if ((pauseCtx->equipTargetItem >= 0xBF) && (pauseCtx->equipTargetItem <= 0xC1) &&
                            ((GET_EQUIPS_BUTTON_ITEMS[1] == ITEM_BOW) ||
                             ((GET_EQUIPS_BUTTON_ITEMS[1] >= ITEM_BOW_ARROW_FIRE) &&
                              (GET_EQUIPS_BUTTON_ITEMS[1] <= ITEM_BOW_ARROW_LIGHT)))) {
                            pauseCtx->equipTargetItem -= 0xBF - ITEM_BOW_ARROW_FIRE;
                            pauseCtx->equipTargetSlot = SLOT_BOW;
                        } else {
                            GET_EQUIPS_BUTTON_ITEMS[2] = GET_EQUIPS_BUTTON_ITEMS[1];
                            GET_EQUIPS_C_BUTTON_SLOTS[1] =
                                GET_EQUIPS_C_BUTTON_SLOTS[0];
                            Interface_LoadItemIcon2(play, 2);
                        }
                    } else {
                        GET_EQUIPS_BUTTON_ITEMS[2] = ITEM_NONE;
                        GET_EQUIPS_C_BUTTON_SLOTS[1] = SLOT_NONE;
                    }
                } else if (pauseCtx->equipTargetSlot == GET_EQUIPS_C_BUTTON_SLOTS[2]) {
                    if (GET_EQUIPS_BUTTON_ITEMS[1] != ITEM_NONE) {
                        if ((pauseCtx->equipTargetItem >= 0xBF) && (pauseCtx->equipTargetItem <= 0xC1) &&
                            ((GET_EQUIPS_BUTTON_ITEMS[1] == ITEM_BOW) ||
                             ((GET_EQUIPS_BUTTON_ITEMS[1] >= ITEM_BOW_ARROW_FIRE) &&
                            ...
                            GET_EQUIPS_BUTTON_ITEMS[3] = GET_EQUIPS_BUTTON_ITEMS[1];
                            GET_EQUIPS_C_BUTTON_SLOTS[2] =
                                GET_EQUIPS_C_BUTTON_SLOTS[0];
                            Interface_LoadItemIcon2(play, 3);
                        }
                    } else {
                        GET_EQUIPS_BUTTON_ITEMS[3] = ITEM_NONE;
                        GET_EQUIPS_C_BUTTON_SLOTS[2] = SLOT_NONE;
                    }
                }

                if ((pauseCtx->equipTargetItem >= 0xBF) && (pauseCtx->equipTargetItem <= 0xC1)) {
                    if ((GET_EQUIPS_BUTTON_ITEMS[1] == ITEM_BOW) ||
                        ((GET_EQUIPS_BUTTON_ITEMS[1] >= ITEM_BOW_ARROW_FIRE) &&
                         (GET_EQUIPS_BUTTON_ITEMS[1] <= ITEM_BOW_ARROW_LIGHT))) {
                        pauseCtx->equipTargetItem -= 0xBF - ITEM_BOW_ARROW_FIRE;
                        pauseCtx->equipTargetSlot = SLOT_BOW;
                    ...
                    if ((GET_EQUIPS_BUTTON_ITEMS[2] >= ITEM_BOW_ARROW_FIRE) &&
                        (GET_EQUIPS_BUTTON_ITEMS[2] <= ITEM_BOW_ARROW_LIGHT)) {
                        GET_EQUIPS_BUTTON_ITEMS[2] = GET_EQUIPS_BUTTON_ITEMS[1];
                        GET_EQUIPS_C_BUTTON_SLOTS[1] = GET_EQUIPS_C_BUTTON_SLOTS[0];
                        Interface_LoadItemIcon2(play, 2);
                    } else if ((GET_EQUIPS_BUTTON_ITEMS[3] >= ITEM_BOW_ARROW_FIRE) &&
                               (GET_EQUIPS_BUTTON_ITEMS[3] <= ITEM_BOW_ARROW_LIGHT)) {
                        GET_EQUIPS_BUTTON_ITEMS[3] = GET_EQUIPS_BUTTON_ITEMS[1];
                        GET_EQUIPS_C_BUTTON_SLOTS[2] = GET_EQUIPS_C_BUTTON_SLOTS[0];
                        Interface_LoadItemIcon2(play, 3);
                    }
                }

                GET_EQUIPS_BUTTON_ITEMS[1] = pauseCtx->equipTargetItem;
                GET_EQUIPS_C_BUTTON_SLOTS[0] = pauseCtx->equipTargetSlot;
                Interface_LoadItemIcon1(play, 1);

                osSyncPrintf("Ｃ左sl_item_no=%d (1)=%d (2)=%d (3)=%d\n", pauseCtx->equipTargetItem,
                             GET_EQUIPS_BUTTON_ITEMS[1], GET_EQUIPS_BUTTON_ITEMS[2],
                             GET_EQUIPS_BUTTON_ITEMS[3]);
                ...
                if (pauseCtx->equipTargetSlot == GET_EQUIPS_C_BUTTON_SLOTS[0]) {
                    if (GET_EQUIPS_BUTTON_ITEMS[2] != ITEM_NONE) {
                        if ((pauseCtx->equipTargetItem >= 0xBF) && (pauseCtx->equipTargetItem <= 0xC1) &&
                            ((GET_EQUIPS_BUTTON_ITEMS[2] == ITEM_BOW) ||
                             ((GET_EQUIPS_BUTTON_ITEMS[2] >= ITEM_BOW_ARROW_FIRE) &&
                              (GET_EQUIPS_BUTTON_ITEMS[2] <= ITEM_BOW_ARROW_LIGHT)))) {
                            pauseCtx->equipTargetItem -= 0xBF - ITEM_BOW_ARROW_FIRE;
                            pauseCtx->equipTargetSlot = SLOT_BOW;
                        } else {
                        ...
                        GET_EQUIPS_BUTTON_ITEMS[1] = ITEM_NONE;
                        GET_EQUIPS_C_BUTTON_SLOTS[0] = SLOT_NONE;
                    }
                } else if (pauseCtx->equipTargetSlot == GET_EQUIPS_C_BUTTON_SLOTS[2]) {
                    if (GET_EQUIPS_BUTTON_ITEMS[2] != ITEM_NONE) {
                        if ((pauseCtx->equipTargetItem >= 0xBF) && (pauseCtx->equipTargetItem <= 0xC1) &&
                            ...
                            GET_EQUIPS_BUTTON_ITEMS[3] = GET_EQUIPS_BUTTON_ITEMS[2];
                            GET_EQUIPS_C_BUTTON_SLOTS[2] =
                                GET_EQUIPS_C_BUTTON_SLOTS[1];
                            Interface_LoadItemIcon2(play, 3);
                        }
                ...
                if ((pauseCtx->equipTargetItem >= 0xBF) && (pauseCtx->equipTargetItem <= 0xC1)) {
                    if ((GET_EQUIPS_BUTTON_ITEMS[2] == ITEM_BOW) ||
                        ((GET_EQUIPS_BUTTON_ITEMS[2] >= ITEM_BOW_ARROW_FIRE) &&
                         (GET_EQUIPS_BUTTON_ITEMS[2] <= ITEM_BOW_ARROW_LIGHT))) {
                        pauseCtx->equipTargetItem -= 0xBF - ITEM_BOW_ARROW_FIRE;
                        pauseCtx->equipTargetSlot = SLOT_BOW;
                    ...
                    if ((GET_EQUIPS_BUTTON_ITEMS[1] >= ITEM_BOW_ARROW_FIRE) &&
                        (GET_EQUIPS_BUTTON_ITEMS[1] <= ITEM_BOW_ARROW_LIGHT)) {
                        GET_EQUIPS_BUTTON_ITEMS[1] = GET_EQUIPS_BUTTON_ITEMS[2];
                        Interface_LoadItemIcon2(play, 1);
                    } else if ((GET_EQUIPS_BUTTON_ITEMS[3] >= ITEM_BOW_ARROW_FIRE) &&
                ...
                GET_EQUIPS_BUTTON_ITEMS[2] = pauseCtx->equipTargetItem;
                GET_EQUIPS_C_BUTTON_SLOTS[1] = pauseCtx->equipTargetSlot;
                ...
                if (pauseCtx->equipTargetSlot == GET_EQUIPS_C_BUTTON_SLOTS[0]) {
                    if (GET_EQUIPS_BUTTON_ITEMS[3] != ITEM_NONE) {
                        if ((pauseCtx->equipTargetItem >= 0xBF) && (pauseCtx->equipTargetItem <= 0xC1) &&
                            ((GET_EQUIPS_BUTTON_ITEMS[3] == ITEM_BOW) ||
                             ((GET_EQUIPS_BUTTON_ITEMS[3] >= ITEM_BOW_ARROW_FIRE) &&
                              (GET_EQUIPS_BUTTON_ITEMS[3] <= ITEM_BOW_ARROW_LIGHT)))) {
                            pauseCtx->equipTargetItem -= 0xBF - ITEM_BOW_ARROW_FIRE;
                            pauseCtx->equipTargetSlot = SLOT_BOW;
                        } else {
                            GET_EQUIPS_BUTTON_ITEMS[1] = GET_EQUIPS_BUTTON_ITEMS[3];
                            GET_EQUIPS_C_BUTTON_SLOTS[0] =
                                GET_EQUIPS_C_BUTTON_SLOTS[2];
                            Interface_LoadItemIcon2(play, 1);
                        }
                ...
                } else if (pauseCtx->equipTargetSlot == GET_EQUIPS_C_BUTTON_SLOTS[1]) {
                    if (GET_EQUIPS_BUTTON_ITEMS[3] != ITEM_NONE) {
                        if ((pauseCtx->equipTargetItem >= 0xBF) && (pauseCtx->equipTargetItem <= 0xC1) &&
                            ((GET_EQUIPS_BUTTON_ITEMS[3] == ITEM_BOW) ||
                             ((GET_EQUIPS_BUTTON_ITEMS[3] >= ITEM_BOW_ARROW_FIRE) &&
                            ...
                            GET_EQUIPS_BUTTON_ITEMS[2] = GET_EQUIPS_BUTTON_ITEMS[3];
                            GET_EQUIPS_C_BUTTON_SLOTS[1] =
                                GET_EQUIPS_C_BUTTON_SLOTS[2];
                            Interface_LoadItemIcon2(play, 2);
                        }
                ...
                if ((pauseCtx->equipTargetItem >= 0xBF) && (pauseCtx->equipTargetItem <= 0xC1)) {
                    if ((GET_EQUIPS_BUTTON_ITEMS[3] == ITEM_BOW) ||
                        ((GET_EQUIPS_BUTTON_ITEMS[3] >= ITEM_BOW_ARROW_FIRE) &&
                         (GET_EQUIPS_BUTTON_ITEMS[3] <= ITEM_BOW_ARROW_LIGHT))) {
                        pauseCtx->equipTargetItem -= 0xBF - ITEM_BOW_ARROW_FIRE;
                        pauseCtx->equipTargetSlot = SLOT_BOW;
                    ...
                    if ((GET_EQUIPS_BUTTON_ITEMS[1] >= ITEM_BOW_ARROW_FIRE) &&
                        ...
                        GET_EQUIPS_BUTTON_ITEMS[1] = GET_EQUIPS_BUTTON_ITEMS[3];
                        Interface_LoadItemIcon2(play, 1);
                    } else if ((GET_EQUIPS_BUTTON_ITEMS[2] >= ITEM_BOW_ARROW_FIRE) &&
                               (GET_EQUIPS_BUTTON_ITEMS[2] <= ITEM_BOW_ARROW_LIGHT)) {
                        GET_EQUIPS_BUTTON_ITEMS[2] = GET_EQUIPS_BUTTON_ITEMS[3];
                        Interface_LoadItemIcon2(play, 2);
                    }
                ...
                GET_EQUIPS_BUTTON_ITEMS[3] = pauseCtx->equipTargetItem;
                GET_EQUIPS_C_BUTTON_SLOTS[2] = pauseCtx->equipTargetSlot;
