...
void EnGSwitch_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    switch (this->type) {
        ...
        case ENGSWITCH_ARCHERY_POT:
            ...
            this->collider.elem.acDmgInfo.dmgFlags = 0x1F820;
            ...
            this->collider.shape.radius = 24;
            this->collider.shape.height = 74;
        ...
        case ENGSWITCH_TARGET_RUPEE:
            ...
            this->collider.shape.height = 60;
            this->collider.shape.yShift = 5;
