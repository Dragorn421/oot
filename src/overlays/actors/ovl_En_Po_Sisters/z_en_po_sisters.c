...
ColliderCylinderSrc sCylinderInit_EnPoSisters = {
    {
        COL_MATERIAL_HIT3,
        AT_ON | AT_TYPE_ENEMY,
...
static CollideDataInit sCollideDataInit = { 0x0A, 0x0019, 0x003C, 0x28 };
...
void EnPoSisters_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    Collider_LoadCylinder(globalCtx, &this->collider, &this->actor, &sCylinderInit_EnPoSisters);
    ...
    if (this->actor.params & 0x1000) {
        ...
        if (this->unk_195 == 0) {
            ...
            this->collider.elem.elemMaterial = 4;
            this->collider.elem.acDmgInfo.dmgFlags |= 1;
...
void func_80AD95D8(EnPoSisters* this) {
    ...
    if (this->collider.base.ac != NULL) {
        this->actor.posRot.rot.y = (this->collider.elem.acHitElem->atDmgInfo.dmgFlags & 0x1F824)
...
void func_80ADAD54(EnPoSisters* this, GlobalContext* globalCtx) {
    ...
    if (SkelAnime_Update(&this->skelAnime)) {
        this->unk_22E.a = 0;
        this->collider.elem.acDmgInfo.dmgFlags = 0x60001;
        func_80AD93C4(this);
    } else {
...
void func_80ADAE6C(EnPoSisters* this, GlobalContext* globalCtx) {
    if (SkelAnime_Update(&this->skelAnime)) {
        ...
        if (this->unk_194 != 0) {
            this->unk_199 |= 1;
            this->collider.elem.acDmgInfo.dmgFlags = 0x4FC7FFEA;
            if (this->unk_19A != 0) {
                this->unk_19A--;
            }
            if (this->unk_19A == 0) {
...
void func_80ADC10C(EnPoSisters* this, GlobalContext* globalCtx) {
    ...
    if (this->collider.base.acFlags & 2) {
        ...
        } else if (this->collider.base.colMaterial == 9 ||
                   (this->actor.collideData.damageEffect == 0 && this->actor.collideData.damage == 0)) {
            if (this->unk_194 == 0) {
                this->actor.freezeTimer = 0;
            }
        } else if (this->actor.collideData.damageEffect == 0xF) {
            this->actor.posRot.rot.y = this->actor.shape.rot.y;
            this->unk_199 |= 2;
            func_80AD98F4(this, globalCtx);
        } else if (this->unk_194 == 0 && this->actor.collideData.damageEffect == 0xE &&
                   this->actionFunc == func_80ADB770) {
            if (this->unk_19C == 0) {
                this->unk_19C = -45;
            }
