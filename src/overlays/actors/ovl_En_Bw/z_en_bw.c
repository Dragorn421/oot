...
static ColliderCylinderSrc sCylinderInit1 = {
    {
        COL_MATERIAL_NONE,
        AT_ON | AT_TYPE_ENEMY,
        AC_NONE,
...
void EnBw_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    Collider_LoadCylinder(globalCtx, &this->collider1, &this->actor, &sCylinderInit1);
    Collider_LoadCylinder(globalCtx, &this->collider2, &this->actor, &sCylinderInit2);
...
void func_809D0584(EnBw* this, GlobalContext* globalCtx) {
    if ((this->actor.bgCheckFlags & 0x10) && (this->actor.bgCheckFlags & 1)) {
        ...
        if (this->collider2.base.acFlags & 2) {
            ...
            if ((this->actor.collideData.damageEffect == 0) || (this->unk_220 == 6)) {
                return;
            }
            this->damageEffect = this->actor.collideData.damageEffect;
            func_80035650(&this->actor, &this->collider2.elem, 0);
            ...
            if (((this->unk_221 == 1) || (this->unk_221 == 4)) && (this->actor.collideData.health == 0)) {
                if (this->unk_220 != 0) {
...
void EnBw_Update(Actor* thisx, GlobalContext* globalCtx2) {
    ...
    if (thisx->collideData.damageEffect != 6) {
        ...
        if (this->unk_248 <= 0.4f) {
            this->collider1.elem.atDmgInfo.hitSpecialEffect = 0;
            ...
            this->collider1.elem.atDmgInfo.hitSpecialEffect = 1;
        }
    ...
    Collider_UpdateCylinderShape(thisx, &this->collider2);
