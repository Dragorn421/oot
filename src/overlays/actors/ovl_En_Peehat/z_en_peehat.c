...
typedef enum EnPeehatDamageReaction {
    /* 00 */ PEAHAT_DMG_REACTION_ATTACK = 0,
    /* 06 */ PEAHAT_DMG_REACTION_LIGHT_ICE_ARROW = 6,
    /* 12 */ PEAHAT_DMG_REACTION_FIRE = 12,
    /* 13 */ PEAHAT_DMG_REACTION_HOOKSHOT = 13,
    /* 14 */ PEAHAT_DMG_REACTION_BOOMERANG = 14,
    /* 15 */ PEAHAT_DMG_REACTION_NUT = 15
} EnPeehatDamageReaction;

static DamageTable sDamageTable = {
    /* Deku nut      */ DMG_ENTRY(0, PEAHAT_DMG_REACTION_NUT),
    /* Deku stick    */ DMG_ENTRY(2, PEAHAT_DMG_REACTION_ATTACK),
    /* Slingshot     */ DMG_ENTRY(1, PEAHAT_DMG_REACTION_ATTACK),
    /* Explosive     */ DMG_ENTRY(2, PEAHAT_DMG_REACTION_ATTACK),
    /* Boomerang     */ DMG_ENTRY(0, PEAHAT_DMG_REACTION_BOOMERANG),
    /* Normal arrow  */ DMG_ENTRY(2, PEAHAT_DMG_REACTION_ATTACK),
    /* Hammer swing  */ DMG_ENTRY(2, PEAHAT_DMG_REACTION_ATTACK),
    /* Hookshot      */ DMG_ENTRY(2, PEAHAT_DMG_REACTION_HOOKSHOT),
    /* Kokiri sword  */ DMG_ENTRY(1, PEAHAT_DMG_REACTION_ATTACK),
    /* Master sword  */ DMG_ENTRY(2, PEAHAT_DMG_REACTION_ATTACK),
    /* Giant's Knife */ DMG_ENTRY(4, PEAHAT_DMG_REACTION_ATTACK),
    /* Fire arrow    */ DMG_ENTRY(4, PEAHAT_DMG_REACTION_FIRE),
    /* Ice arrow     */ DMG_ENTRY(2, PEAHAT_DMG_REACTION_ATTACK),
    /* Light arrow   */ DMG_ENTRY(2, PEAHAT_DMG_REACTION_ATTACK),
    /* Unk arrow 1   */ DMG_ENTRY(2, PEAHAT_DMG_REACTION_ATTACK),
    /* Unk arrow 2   */ DMG_ENTRY(2, PEAHAT_DMG_REACTION_ATTACK),
    /* Unk arrow 3   */ DMG_ENTRY(2, PEAHAT_DMG_REACTION_ATTACK),
    /* Fire magic    */ DMG_ENTRY(3, PEAHAT_DMG_REACTION_FIRE),
    /* Ice magic     */ DMG_ENTRY(0, PEAHAT_DMG_REACTION_LIGHT_ICE_ARROW),
    /* Light magic   */ DMG_ENTRY(0, PEAHAT_DMG_REACTION_LIGHT_ICE_ARROW),
    /* Shield        */ DMG_ENTRY(0, PEAHAT_DMG_REACTION_ATTACK),
    /* Mirror Ray    */ DMG_ENTRY(0, PEAHAT_DMG_REACTION_ATTACK),
    /* Kokiri spin   */ DMG_ENTRY(1, PEAHAT_DMG_REACTION_ATTACK),
    /* Giant spin    */ DMG_ENTRY(4, PEAHAT_DMG_REACTION_ATTACK),
    /* Master spin   */ DMG_ENTRY(2, PEAHAT_DMG_REACTION_ATTACK),
    /* Kokiri jump   */ DMG_ENTRY(2, PEAHAT_DMG_REACTION_ATTACK),
    /* Giant jump    */ DMG_ENTRY(8, PEAHAT_DMG_REACTION_ATTACK),
    /* Master jump   */ DMG_ENTRY(4, PEAHAT_DMG_REACTION_ATTACK),
    /* Unknown 1     */ DMG_ENTRY(0, PEAHAT_DMG_REACTION_ATTACK),
    /* Unblockable   */ DMG_ENTRY(0, PEAHAT_DMG_REACTION_ATTACK),
    /* Hammer jump   */ DMG_ENTRY(4, PEAHAT_DMG_REACTION_ATTACK),
    /* Unknown 2     */ DMG_ENTRY(0, PEAHAT_DMG_REACTION_ATTACK),
};
...
void EnPeehat_Adult_CollisionCheck(EnPeehat* this, PlayState* play) {
    if ((this->colliderCylinder.base.acFlags & AC_BOUNCED) || (this->colliderQuad.base.acFlags & AC_BOUNCED)) {
        ...
        if (this->actor.colChkInfo.damageReaction == PEAHAT_DMG_REACTION_NUT ||
            this->actor.colChkInfo.damageReaction == PEAHAT_DMG_REACTION_LIGHT_ICE_ARROW) {
            return;
        }
        if (this->actor.colChkInfo.damageReaction == PEAHAT_DMG_REACTION_HOOKSHOT) {
            this->actor.colChkInfo.health = 0;
        } else if (this->actor.colChkInfo.damageReaction == PEAHAT_DMG_REACTION_BOOMERANG) {
            if (this->state != PEAHAT_STATE_STUNNED) {
        ...
        if (this->actor.colChkInfo.damageReaction == PEAHAT_DMG_REACTION_FIRE) {
            Vec3f pos;
            s32 i;
            for (i = 4; i >= 0; i--) {
                pos.x = Rand_CenteredFloat(20.0f) + this->actor.world.pos.x;
...
void EnPeehat_Update(Actor* thisx, PlayState* play) {
    ...
    if (thisx->colChkInfo.damageReaction != PEAHAT_DMG_REACTION_LIGHT_ICE_ARROW) {
