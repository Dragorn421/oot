...
typedef enum EnWallmasDamageReaction {
    /* 0 */ WALLMAS_DMG_REACTION_NONE,
    /* 1 */ WALLMAS_DMG_REACTION_STUN_BLUE,
    /* 2 */ WALLMAS_DMG_REACTION_BURN,
    /* 4 */ WALLMAS_DMG_REACTION_STUN_WHITE = 4
} EnWallmasDamageReaction;

static DamageTable sDamageTable = {
    /* Deku nut      */ DMG_ENTRY(0, WALLMAS_DMG_REACTION_STUN_BLUE),
    /* Deku stick    */ DMG_ENTRY(2, WALLMAS_DMG_REACTION_NONE),
    /* Slingshot     */ DMG_ENTRY(1, WALLMAS_DMG_REACTION_NONE),
    /* Explosive     */ DMG_ENTRY(2, WALLMAS_DMG_REACTION_NONE),
    /* Boomerang     */ DMG_ENTRY(0, WALLMAS_DMG_REACTION_STUN_BLUE),
    /* Normal arrow  */ DMG_ENTRY(2, WALLMAS_DMG_REACTION_NONE),
    /* Hammer swing  */ DMG_ENTRY(2, WALLMAS_DMG_REACTION_NONE),
    /* Hookshot      */ DMG_ENTRY(0, WALLMAS_DMG_REACTION_STUN_BLUE),
    /* Kokiri sword  */ DMG_ENTRY(1, WALLMAS_DMG_REACTION_NONE),
    /* Master sword  */ DMG_ENTRY(2, WALLMAS_DMG_REACTION_NONE),
    /* Giant's Knife */ DMG_ENTRY(4, WALLMAS_DMG_REACTION_NONE),
    /* Fire arrow    */ DMG_ENTRY(4, WALLMAS_DMG_REACTION_BURN),
    /* Ice arrow     */ DMG_ENTRY(2, WALLMAS_DMG_REACTION_NONE),
    /* Light arrow   */ DMG_ENTRY(4, WALLMAS_DMG_REACTION_STUN_WHITE),
    /* Unk arrow 1   */ DMG_ENTRY(4, WALLMAS_DMG_REACTION_NONE),
    /* Unk arrow 2   */ DMG_ENTRY(2, WALLMAS_DMG_REACTION_NONE),
    /* Unk arrow 3   */ DMG_ENTRY(2, WALLMAS_DMG_REACTION_NONE),
    /* Fire magic    */ DMG_ENTRY(4, WALLMAS_DMG_REACTION_BURN),
    /* Ice magic     */ DMG_ENTRY(0, WALLMAS_DMG_REACTION_NONE),
    /* Light magic   */ DMG_ENTRY(4, WALLMAS_DMG_REACTION_STUN_WHITE),
    /* Shield        */ DMG_ENTRY(0, WALLMAS_DMG_REACTION_NONE),
    /* Mirror Ray    */ DMG_ENTRY(0, WALLMAS_DMG_REACTION_NONE),
    /* Kokiri spin   */ DMG_ENTRY(1, WALLMAS_DMG_REACTION_NONE),
    /* Giant spin    */ DMG_ENTRY(4, WALLMAS_DMG_REACTION_NONE),
    /* Master spin   */ DMG_ENTRY(2, WALLMAS_DMG_REACTION_NONE),
    /* Kokiri jump   */ DMG_ENTRY(2, WALLMAS_DMG_REACTION_NONE),
    /* Giant jump    */ DMG_ENTRY(8, WALLMAS_DMG_REACTION_NONE),
    /* Master jump   */ DMG_ENTRY(4, WALLMAS_DMG_REACTION_NONE),
    /* Unknown 1     */ DMG_ENTRY(0, WALLMAS_DMG_REACTION_NONE),
    /* Unblockable   */ DMG_ENTRY(0, WALLMAS_DMG_REACTION_NONE),
    /* Hammer jump   */ DMG_ENTRY(4, WALLMAS_DMG_REACTION_NONE),
    /* Unknown 2     */ DMG_ENTRY(0, WALLMAS_DMG_REACTION_NONE),
};
...
void EnWallmas_ColUpdate(EnWallmas* this, PlayState* play) {
    if (this->collider.base.acFlags & AC_HIT) {
        ...
        if ((this->actor.colChkInfo.damageReaction != 0) || (this->actor.colChkInfo.damage != 0)) {
            ...
            if ((this->actor.colChkInfo.damageReaction == WALLMAS_DMG_REACTION_STUN_WHITE) ||
                (this->actor.colChkInfo.damageReaction == WALLMAS_DMG_REACTION_STUN_BLUE)) {
                if (this->actionFunc != EnWallmas_Stun) {
                    EnWallmas_SetupStun(this);
                }
            } else {
                if (this->actor.colChkInfo.damageReaction == WALLMAS_DMG_REACTION_BURN) {
