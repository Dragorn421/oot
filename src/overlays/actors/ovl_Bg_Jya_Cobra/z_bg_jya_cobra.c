...
void func_80895A70(BgJyaCobra* this) {
    ...
    switch (this->dyna.actor.params & 3) {
        case 0:
            ...
            break;
        case 1:
            phi_v0 = temp_v1->unk160[1];
            if (phi_v0 == NULL) {
                return;
            }
            break;
        case 2:
            phi_v0 = temp_v1->unk160[2];
            if (phi_v0 == NULL) {
                return;
            }
            break;
    ...
    phi_v0->unk2AE = 0;
    Math_Vec3f_Copy(&phi_v0->coneFrustumCenterTop, &this->unk_180);
    ...
    Matrix_MultVec3f(&sp28, &phi_v0->coneFrustumCenterBase);
    Math_Vec3f_Sum(&phi_v0->coneFrustumCenterTop, &phi_v0->coneFrustumCenterBase, &phi_v0->coneFrustumCenterBase);
}
#else
...
void BgJyaCobra_Draw(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if ((this->dyna.actor.params & 3) == 2) {
        ...
        if (mirror != NULL && (mirror->unk15C & 4) &&
            (mirror->unk15C & 1)) {
