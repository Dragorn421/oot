...
static CollideDataInitAlt D_80AFBADC = {
...
void EnSi_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    func_80061EFC(&this->actor.collideData, NULL, &D_80AFBADC);
...
void func_80AFB768(EnSi* this, GlobalContext* globalCtx) {
    ...
    if ((this->actor.flags & 0x2000) == 0x2000) {
        ...
        if (func_8008E988(globalCtx) == 0) {
            ...
            if (this->collider.base.ocFlags2 & 0x1) {
                this->collider.base.ocFlags2 &= ~0x1;
