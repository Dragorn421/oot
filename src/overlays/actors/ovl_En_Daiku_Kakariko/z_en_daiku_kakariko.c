...
void EnDaikuKakariko_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    SkelAnime_InitFlex(globalCtx, &this->skelAnime, &object_daiku_Skel_007958, NULL, &this->jointTable,
                       &this->morphTable, 17);
...
void EnDaikuKakariko_Run(EnDaikuKakariko* this, GlobalContext* globalCtx) {
    ...
    if (this->flags & 0x40) {
        Actor_UpdateBgCheckInfo(globalCtx, this, 0.0f, 0.0f, 0.0f, UPDBGCHECKINFO_FLAG_2);
