...
void func_809937B4(DemoTreLgt* this, PlayState* play, f32 currentFrame) {
    ...
    SkelCurve_SetAnim(skelCurve, sAnimations[GET_LINK_AGE], 1.0f,
                      sDemoTreLgtInfo[GET_LINK_AGE].endFrame +
                          sDemoTreLgtInfo[GET_LINK_AGE].unk_08,
                      currentFrame, 1.0f);
...
void func_80993848(DemoTreLgt* this, PlayState* play) {
    ...
    if (currentFrame < sDemoTreLgtInfo[(GET_LINK_AGE_VOID0)].endFrame) {
        this->unk_170 = 255;
    } else {
        if (currentFrame <= (sDemoTreLgtInfo[(GET_LINK_AGE_VOID0)].endFrame +
                             sDemoTreLgtInfo[(GET_LINK_AGE_VOID0)].unk_08)) {
            this->unk_170 = ((((sDemoTreLgtInfo[(GET_LINK_AGE_VOID0)].endFrame - currentFrame) /
                               sDemoTreLgtInfo[(GET_LINK_AGE_VOID0)].unk_08) *
                              255.0f) +
                             255.0f);
        } else {
    ...
    if (currentFrame < sDemoTreLgtInfo[(GET_LINK_AGE_VOID0)].unk_0C) {
        this->unk_174 = 255;
    } else if (currentFrame < (sDemoTreLgtInfo[(GET_LINK_AGE_VOID0)].unk_0C + 10.0f)) {
        this->unk_174 =
            ((((sDemoTreLgtInfo[(GET_LINK_AGE_VOID0)].unk_0C - currentFrame) / 10.0f) * 255.0f) +
             255.0f);
    } else {
        this->unk_174 = 0;
    }
