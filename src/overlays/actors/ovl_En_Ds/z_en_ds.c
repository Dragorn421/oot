            ...
            case 0: // yes
                switch (EnDs_CheckRupeesAndBottle()) {
                    ...
                    case 2: // have 100 rupees and empty bottle
                        Rupees_ChangeBy(-100);
                        this->actor.flags &= ~ACTOR_FLAG_16;
                        func_8002F434(this, play, GI_POTION_BLUE, 10000.0f, 50.0f);
...
void EnDs_Wait(EnDs* this, PlayState* play) {
    ...
    if (Actor_ProcessTalkRequest(&this->actor, play)) {
        ...
        if ((ABS(yawDiff) < 0x2151) && (this->actor.xzDistToPlayer < 200.0f)) {
            func_8002F298(this, play, 100.0f, EXCH_ITEM_ODD_MUSHROOM);
            this->unk_1E8 |= 1;
        }
    }
}
...
void EnDs_Update(Actor* thisx, PlayState* play) {
    ...
    if (this->unk_1E8 & 1) {
        func_80038290(play, this, &this->unk_1D8, &this->unk_1DE, this->actor.focus.pos);
    } else {
