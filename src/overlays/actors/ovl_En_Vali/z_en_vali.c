...
typedef enum BariDamageReaction {
    /* 0x0 */ BARI_DMG_REACTION_NONE,
    /* 0x1 */ BARI_DMG_REACTION_STUN,
    /* 0x2 */ BARI_DMG_REACTION_FIRE,
    /* 0x3 */ BARI_DMG_REACTION_ICE,
    /* 0xE */ BARI_DMG_REACTION_SLINGSHOT = 0xE,
    /* 0xF */ BARI_DMG_REACTION_SWORD
} BariDamageReaction;

static DamageTable sDamageTable = {
    /* Deku nut      */ DMG_ENTRY(0, BARI_DMG_REACTION_STUN),
    /* Deku stick    */ DMG_ENTRY(2, BARI_DMG_REACTION_NONE),
    /* Slingshot     */ DMG_ENTRY(0, BARI_DMG_REACTION_SLINGSHOT),
    /* Explosive     */ DMG_ENTRY(2, BARI_DMG_REACTION_NONE),
    /* Boomerang     */ DMG_ENTRY(0, BARI_DMG_REACTION_STUN),
    /* Normal arrow  */ DMG_ENTRY(2, BARI_DMG_REACTION_NONE),
    /* Hammer swing  */ DMG_ENTRY(2, BARI_DMG_REACTION_NONE),
    /* Hookshot      */ DMG_ENTRY(2, BARI_DMG_REACTION_NONE),
    /* Kokiri sword  */ DMG_ENTRY(1, BARI_DMG_REACTION_SWORD),
    /* Master sword  */ DMG_ENTRY(2, BARI_DMG_REACTION_SWORD),
    /* Giant's Knife */ DMG_ENTRY(4, BARI_DMG_REACTION_SWORD),
    /* Fire arrow    */ DMG_ENTRY(4, BARI_DMG_REACTION_FIRE),
    /* Ice arrow     */ DMG_ENTRY(4, BARI_DMG_REACTION_ICE),
    /* Light arrow   */ DMG_ENTRY(2, BARI_DMG_REACTION_NONE),
    /* Unk arrow 1   */ DMG_ENTRY(2, BARI_DMG_REACTION_NONE),
    /* Unk arrow 2   */ DMG_ENTRY(2, BARI_DMG_REACTION_NONE),
    /* Unk arrow 3   */ DMG_ENTRY(2, BARI_DMG_REACTION_NONE),
    /* Fire magic    */ DMG_ENTRY(4, BARI_DMG_REACTION_FIRE),
    /* Ice magic     */ DMG_ENTRY(4, BARI_DMG_REACTION_ICE),
    /* Light magic   */ DMG_ENTRY(0, BARI_DMG_REACTION_NONE),
    /* Shield        */ DMG_ENTRY(0, BARI_DMG_REACTION_NONE),
    /* Mirror Ray    */ DMG_ENTRY(0, BARI_DMG_REACTION_NONE),
    /* Kokiri spin   */ DMG_ENTRY(1, BARI_DMG_REACTION_NONE),
    /* Giant spin    */ DMG_ENTRY(4, BARI_DMG_REACTION_NONE),
    /* Master spin   */ DMG_ENTRY(2, BARI_DMG_REACTION_NONE),
    /* Kokiri jump   */ DMG_ENTRY(2, BARI_DMG_REACTION_NONE),
    /* Giant jump    */ DMG_ENTRY(8, BARI_DMG_REACTION_NONE),
    /* Master jump   */ DMG_ENTRY(4, BARI_DMG_REACTION_NONE),
    /* Unknown 1     */ DMG_ENTRY(0, BARI_DMG_REACTION_NONE),
    /* Unblockable   */ DMG_ENTRY(0, BARI_DMG_REACTION_NONE),
    /* Hammer jump   */ DMG_ENTRY(4, BARI_DMG_REACTION_NONE),
    /* Unknown 2     */ DMG_ENTRY(0, BARI_DMG_REACTION_NONE),
};
...
void EnVali_UpdateDamage(EnVali* this, PlayState* play) {
    if (this->bodyCollider.base.acFlags & AC_HIT) {
        ...
        if ((this->actor.colChkInfo.damageReaction != BARI_DMG_REACTION_NONE) || (this->actor.colChkInfo.damage != 0)) {
            if (Actor_ApplyDamage(&this->actor) == 0) {
                Actor_PlaySfx(&this->actor, NA_SE_EN_BARI_DEAD);
                Enemy_StartFinishingBlow(play, &this->actor);
                this->actor.flags &= ~ACTOR_FLAG_ATTENTION_ENABLED;
            } else if ((this->actor.colChkInfo.damageReaction != BARI_DMG_REACTION_STUN) &&
                       (this->actor.colChkInfo.damageReaction != BARI_DMG_REACTION_SLINGSHOT)) {
                Actor_PlaySfx(&this->actor, NA_SE_EN_BARI_DAMAGE);
            }

            if (this->actor.colChkInfo.damageReaction == BARI_DMG_REACTION_STUN) {
                if (this->actionFunc != EnVali_Stunned) {
                    EnVali_SetupStunned(this);
                }
            } else if (this->actor.colChkInfo.damageReaction == BARI_DMG_REACTION_SWORD) {
                if (this->actionFunc != EnVali_Stunned) {
                    Actor_SetColorFilter(&this->actor, COLORFILTER_COLORFLAG_RED, 150, COLORFILTER_BUFFLAG_XLU, 30);
            ...
            } else if (this->actor.colChkInfo.damageReaction == BARI_DMG_REACTION_FIRE) {
                EnVali_SetupBurnt(this);
            } else if (this->actor.colChkInfo.damageReaction == BARI_DMG_REACTION_ICE) {
                EnVali_SetupFrozen(this);
            } else if (this->actor.colChkInfo.damageReaction == BARI_DMG_REACTION_SLINGSHOT) {
                if (this->slingshotReactionTimer == 0) {
