...
ColliderSpheresElementSrc sColliderItemInit_EnInsect[1] = {
    {
        {
            ELEM_MATERIAL_UNK0,
            {
...
ColliderSpheresSrc sColliderInit_EnInsect = {
    {
        COL_MATERIAL_NONE,
        AT_NONE,
        AC_NONE,
...
void EnInsect_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    Collider_LoadSpheres(globalCtx, &this->collider, &this->actor, &sColliderInit_EnInsect, &this->colliderItem);

    this->actor.collideData.mass = 30;
