...
void EnMa3_Init(EnMa3* this, GlobalContext* globalCtx) {
    ...
    Collider_LoadCylinder(globalCtx, collider, &this->actor, &cylinderInit_EnMa3);
...
void EnMa3_Update(EnMa3* this, GlobalContext* globalCtx) {
    ...
    func_800343CC(globalCtx, &this->actor, &this->unk_1E0.unk_00, (f32)this->collider.shape.radius + 150.0f,
