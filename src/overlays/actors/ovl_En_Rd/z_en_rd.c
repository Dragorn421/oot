...
typedef enum EnRdDamageReaction {
    /* 0x0 */ REDEAD_DMG_REACTION_NONE,              // Does not interact with the Gibdo/Redead at all
    /* 0x1 */ REDEAD_DMG_REACTION_HOOKSHOT,          // Stuns the Gibdo/Redead
    /* 0x6 */ REDEAD_DMG_REACTION_ICE_MAGIC = 0x6,   // Does not interact with the Gibdo/Redead at all
    /* 0xD */ REDEAD_DMG_REACTION_LIGHT_MAGIC = 0xD, // Stuns the Gibdo/Redead
    /* 0xE */ REDEAD_DMG_REACTION_FIRE_MAGIC,        // Applies a fire effect
    /* 0xF */ REDEAD_DMG_REACTION_DAMAGE             // Deals damage without stunning or applying an effect
} EnRdDamageReaction;

static DamageTable sDamageTable = {
    /* Deku nut      */ DMG_ENTRY(0, REDEAD_DMG_REACTION_NONE),
    /* Deku stick    */ DMG_ENTRY(2, REDEAD_DMG_REACTION_DAMAGE),
    /* Slingshot     */ DMG_ENTRY(0, REDEAD_DMG_REACTION_NONE),
    /* Explosive     */ DMG_ENTRY(0, REDEAD_DMG_REACTION_NONE),
    /* Boomerang     */ DMG_ENTRY(0, REDEAD_DMG_REACTION_NONE),
    /* Normal arrow  */ DMG_ENTRY(0, REDEAD_DMG_REACTION_NONE),
    /* Hammer swing  */ DMG_ENTRY(2, REDEAD_DMG_REACTION_DAMAGE),
    /* Hookshot      */ DMG_ENTRY(0, REDEAD_DMG_REACTION_HOOKSHOT),
    /* Kokiri sword  */ DMG_ENTRY(1, REDEAD_DMG_REACTION_DAMAGE),
    /* Master sword  */ DMG_ENTRY(2, REDEAD_DMG_REACTION_DAMAGE),
    /* Giant's Knife */ DMG_ENTRY(4, REDEAD_DMG_REACTION_DAMAGE),
    /* Fire arrow    */ DMG_ENTRY(0, REDEAD_DMG_REACTION_NONE),
    /* Ice arrow     */ DMG_ENTRY(0, REDEAD_DMG_REACTION_NONE),
    /* Light arrow   */ DMG_ENTRY(0, REDEAD_DMG_REACTION_NONE),
    /* Unk arrow 1   */ DMG_ENTRY(0, REDEAD_DMG_REACTION_NONE),
    /* Unk arrow 2   */ DMG_ENTRY(0, REDEAD_DMG_REACTION_NONE),
    /* Unk arrow 3   */ DMG_ENTRY(0, REDEAD_DMG_REACTION_NONE),
    /* Fire magic    */ DMG_ENTRY(4, REDEAD_DMG_REACTION_FIRE_MAGIC),
    /* Ice magic     */ DMG_ENTRY(0, REDEAD_DMG_REACTION_ICE_MAGIC),
    /* Light magic   */ DMG_ENTRY(3, REDEAD_DMG_REACTION_LIGHT_MAGIC),
    /* Shield        */ DMG_ENTRY(0, REDEAD_DMG_REACTION_NONE),
    /* Mirror Ray    */ DMG_ENTRY(0, REDEAD_DMG_REACTION_NONE),
    /* Kokiri spin   */ DMG_ENTRY(1, REDEAD_DMG_REACTION_DAMAGE),
    /* Giant spin    */ DMG_ENTRY(4, REDEAD_DMG_REACTION_DAMAGE),
    /* Master spin   */ DMG_ENTRY(2, REDEAD_DMG_REACTION_DAMAGE),
    /* Kokiri jump   */ DMG_ENTRY(2, REDEAD_DMG_REACTION_DAMAGE),
    /* Giant jump    */ DMG_ENTRY(8, REDEAD_DMG_REACTION_DAMAGE),
    /* Master jump   */ DMG_ENTRY(4, REDEAD_DMG_REACTION_DAMAGE),
    /* Unknown 1     */ DMG_ENTRY(0, REDEAD_DMG_REACTION_NONE),
    /* Unblockable   */ DMG_ENTRY(0, REDEAD_DMG_REACTION_NONE),
    /* Hammer jump   */ DMG_ENTRY(4, REDEAD_DMG_REACTION_DAMAGE),
    /* Unknown 2     */ DMG_ENTRY(0, REDEAD_DMG_REACTION_NONE),
};
...
void EnRd_SetupStunned(EnRd* this) {
    ...
    } else if (this->damageReaction == REDEAD_DMG_REACTION_HOOKSHOT) {
...
void EnRd_UpdateDamage(EnRd* this, PlayState* play) {
    ...
    if (this->collider.base.acFlags & AC_HIT) {
        ...
        if (this->action != REDEAD_ACTION_RISE_FROM_COFFIN) {
            ...
            if ((this->damageReaction != REDEAD_DMG_REACTION_NONE) &&
                (this->damageReaction != REDEAD_DMG_REACTION_ICE_MAGIC)) {
                if (((this->damageReaction == REDEAD_DMG_REACTION_HOOKSHOT) ||
                     (this->damageReaction == REDEAD_DMG_REACTION_LIGHT_MAGIC)) &&
                    (this->action != REDEAD_ACTION_STUNNED)) {
                ...
                if (this->damageReaction == REDEAD_DMG_REACTION_FIRE_MAGIC) {
