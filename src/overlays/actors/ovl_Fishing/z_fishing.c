...
void Fishing_UpdateFish(Actor* thisx, PlayState* play2) {
    ...
    switch (this->unk_158) {
        ...
        case 11:
            ...
            if (Message_GetState(&play->msgCtx) == TEXT_STATE_NONE) {
                if ((GET_DAY_TIME >= CLOCK_TIME(18, 0)) &&
                    (GET_DAY_TIME <= CLOCK_TIME(18, 0) + 27)) {
                    this->unk_158 = 7;
                    this->unk_17A[3] = (s16)Rand_ZeroFloat(150.0f) + 200;
                }
                if ((GET_DAY_TIME >= CLOCK_TIME(5, 30) - 1) &&
                    (GET_DAY_TIME < CLOCK_TIME(5, 30) + 27)) {
                    this->unk_158 = 7;
                    this->unk_17A[3] = (s16)Rand_ZeroFloat(150.0f) + 200;
                }
            }
        ...
        case 2:
            ...
            if ((GET_DAY_TIME >= CLOCK_TIME(17, 0)) && (GET_DAY_TIME < CLOCK_TIME(19, 0))) {
                multiplier *= 1.75f;
            } else if ((GET_DAY_TIME >= CLOCK_TIME(5, 0)) &&
                       (GET_DAY_TIME < CLOCK_TIME(7, 0))) {
                multiplier *= 1.5f;
...
void Fishing_UpdateOwner(Actor* thisx, PlayState* play2) {
    ...
    SET_MINIGAME_SCORE((SQ((f32)D_80B7A678) * 0.0036f) + 0.5f)
