...
typedef enum EnGeldBDamageReaction {
    /* 0x0 */ GELDB_DMG_REACTION_NORMAL,
    /* 0x1 */ GELDB_DMG_REACTION_STUN,
    /* 0x6 */ GELDB_DMG_REACTION_UNK_6 = 0x6,
    /* 0xD */ GELDB_DMG_REACTION_UNK_D = 0xD,
    /* 0xE */ GELDB_DMG_REACTION_UNK_E,
    /* 0xF */ GELDB_DMG_REACTION_FREEZE
} EnGeldBDamageReaction;

static DamageTable sDamageTable = {
    /* Deku nut      */ DMG_ENTRY(0, GELDB_DMG_REACTION_STUN),
    /* Deku stick    */ DMG_ENTRY(2, GELDB_DMG_REACTION_NORMAL),
    /* Slingshot     */ DMG_ENTRY(1, GELDB_DMG_REACTION_NORMAL),
    /* Explosive     */ DMG_ENTRY(2, GELDB_DMG_REACTION_NORMAL),
    /* Boomerang     */ DMG_ENTRY(0, GELDB_DMG_REACTION_STUN),
    /* Normal arrow  */ DMG_ENTRY(2, GELDB_DMG_REACTION_NORMAL),
    /* Hammer swing  */ DMG_ENTRY(2, GELDB_DMG_REACTION_NORMAL),
    /* Hookshot      */ DMG_ENTRY(0, GELDB_DMG_REACTION_STUN),
    /* Kokiri sword  */ DMG_ENTRY(1, GELDB_DMG_REACTION_NORMAL),
    /* Master sword  */ DMG_ENTRY(2, GELDB_DMG_REACTION_NORMAL),
    /* Giant's Knife */ DMG_ENTRY(4, GELDB_DMG_REACTION_NORMAL),
    /* Fire arrow    */ DMG_ENTRY(2, GELDB_DMG_REACTION_NORMAL),
    /* Ice arrow     */ DMG_ENTRY(2, GELDB_DMG_REACTION_FREEZE),
    /* Light arrow   */ DMG_ENTRY(2, GELDB_DMG_REACTION_NORMAL),
    /* Unk arrow 1   */ DMG_ENTRY(2, GELDB_DMG_REACTION_NORMAL),
    /* Unk arrow 2   */ DMG_ENTRY(2, GELDB_DMG_REACTION_NORMAL),
    /* Unk arrow 3   */ DMG_ENTRY(2, GELDB_DMG_REACTION_NORMAL),
    /* Fire magic    */ DMG_ENTRY(4, GELDB_DMG_REACTION_UNK_E),
    /* Ice magic     */ DMG_ENTRY(0, GELDB_DMG_REACTION_UNK_6),
    /* Light magic   */ DMG_ENTRY(3, GELDB_DMG_REACTION_UNK_D),
    /* Shield        */ DMG_ENTRY(0, GELDB_DMG_REACTION_NORMAL),
    /* Mirror Ray    */ DMG_ENTRY(0, GELDB_DMG_REACTION_NORMAL),
    /* Kokiri spin   */ DMG_ENTRY(1, GELDB_DMG_REACTION_NORMAL),
    /* Giant spin    */ DMG_ENTRY(4, GELDB_DMG_REACTION_NORMAL),
    /* Master spin   */ DMG_ENTRY(2, GELDB_DMG_REACTION_NORMAL),
    /* Kokiri jump   */ DMG_ENTRY(2, GELDB_DMG_REACTION_NORMAL),
    /* Giant jump    */ DMG_ENTRY(8, GELDB_DMG_REACTION_NORMAL),
    /* Master jump   */ DMG_ENTRY(4, GELDB_DMG_REACTION_NORMAL),
    /* Unknown 1     */ DMG_ENTRY(4, GELDB_DMG_REACTION_NORMAL),
    /* Unblockable   */ DMG_ENTRY(0, GELDB_DMG_REACTION_NORMAL),
    /* Hammer jump   */ DMG_ENTRY(4, GELDB_DMG_REACTION_NORMAL),
    /* Unknown 2     */ DMG_ENTRY(0, GELDB_DMG_REACTION_NORMAL),
};
...
void EnGeldB_SetupStunned(EnGeldB* this) {
    ...
    if ((this->damageReaction != GELDB_DMG_REACTION_FREEZE) || (this->action == GELDB_SPIN_ATTACK)) {
        Animation_PlayOnceSetSpeed(&this->skelAnime, &gGerudoRedDamageAnim, 0.0f);
    }
    if (this->damageReaction == GELDB_DMG_REACTION_FREEZE) {
        this->iceTimer = 36;
    }
...
void EnGeldB_CollisionCheck(EnGeldB* this, PlayState* play) {
    ...
    if (this->blockCollider.base.acFlags & AC_BOUNCED) {
        ...
        this->bodyCollider.base.acFlags &= ~AC_HIT;
               ...
               (this->spinAttackState < 2)) {
        this->bodyCollider.base.acFlags &= ~AC_HIT;
        if (this->actor.colChkInfo.damageReaction != GELDB_DMG_REACTION_UNK_6) {
            this->damageReaction = this->actor.colChkInfo.damageReaction;
            Actor_SetDropFlag(&this->actor, &this->bodyCollider.elem, true);
            Audio_StopSfxByPosAndId(&this->actor.projectedPos, NA_SE_EN_GERUDOFT_BREATH);
            if ((this->actor.colChkInfo.damageReaction == GELDB_DMG_REACTION_STUN) ||
                (this->actor.colChkInfo.damageReaction == GELDB_DMG_REACTION_FREEZE)) {
