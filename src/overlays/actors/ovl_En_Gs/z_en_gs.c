...
ColliderCylinderSrc D_80A4FDA0 = {
    {
        COL_MATERIAL_HARD,
        AT_NONE,
...
CollideDataInitAlt D_80A4FDCC = { 0x00, 0x0000, 0x0000, 0x0000, 0xFF };

ActorDamageChart D_80A4FDD8 = { 0x00, 0x00, 0xE0, 0xC0, 0xE0, 0xE0, 0xD0, 0xE0, 0xF0, 0xF0, 0xF0,
...
void EnGs_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    Collider_LoadCylinder(globalCtx, &this->unk_14C, thisx, &D_80A4FDA0);
    func_80061EFC(&thisx->collideData, &D_80A4FDD8, &D_80A4FDCC);
...
void EnGs_Update(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if (!(this->unk_19E & 0x10)) {
        ...
        if (this->unk_14C.base.acFlags & 2) {
            ...
            switch (this->actor.collideData.damageEffect) {
                case 15:
                    this->unk_19E |= 1;
                    func_80A4F77C(this);
        ...
        Collider_UpdateCylinderShape(&this->actor, &this->unk_14C);
        Collider_AddAC(globalCtx, &globalCtx->colliderCtx, &this->unk_14C.base);
        Collider_AddOC(globalCtx, &globalCtx->colliderCtx, &this->unk_14C.base);
    }
