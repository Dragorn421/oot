...
void func_808B7710(Actor* thisx, GlobalContext* globalCtx) {
    ...
    Collider_LoadSpheres(globalCtx, &this->colliderJntSph, &this->dyna.actor, &sJntSphInit, &this->colliderJntSphItems);
...
void BgSpot18Basket_Draw(Actor* thisx, GlobalContext* globalCtx) {
    ...
    func__800628A4_Type0(0, &this->colliderJntSph);
    func__800628A4_Type0(1, &this->colliderJntSph);
