...
u16 EnGo2_GetStateGoronCityRollingBig(PlayState* play, EnGo2* this) {
    s32 bombBagUpgrade;
...
u16 EnGo2_GetStateGoronDmtBombFlower(PlayState* play, EnGo2* this) {
    switch (Message_GetState(&play->msgCtx)) {
        case TEXT_STATE_CLOSING:
...
u16 EnGo2_GetStateGoronDmtRollingSmall(PlayState* play, EnGo2* this) {
...
u16 EnGo2_GetStateGoronDmtDcEntrance(PlayState* play, EnGo2* this) {
    if (Message_GetState(&play->msgCtx) == TEXT_STATE_CLOSING) {
...
u16 EnGo2_GetStateGoronCityEntrance(PlayState* play, EnGo2* this) {
    if (Message_GetState(&play->msgCtx) == TEXT_STATE_CLOSING) {
...
u16 EnGo2_GetStateGoronCityIsland(PlayState* play, EnGo2* this) {
    if (Message_GetState(&play->msgCtx) == TEXT_STATE_CLOSING) {
...
u16 EnGo2_GetStateGoronCityLowestFloor(PlayState* play, EnGo2* this) {
    if (Message_GetState(&play->msgCtx) == TEXT_STATE_CLOSING) {
...
u16 EnGo2_GetStateGoronCityLink(PlayState* play, EnGo2* this) {
...
u16 EnGo2_GetStateGoronDmtBiggoron(PlayState* play, EnGo2* this) {
    s32 unusedPad;
...
u16 EnGo2_GetStateGoronFireGeneric(PlayState* play, EnGo2* this) {
    switch (Message_GetState(&play->msgCtx)) {
        case TEXT_STATE_CLOSING:
            return 0;
        case TEXT_STATE_EVENT:
...
u16 EnGo2_GetStateGoronCityStairwell(PlayState* play, EnGo2* this) {
    if (Message_GetState(&play->msgCtx) == TEXT_STATE_CLOSING) {
...
u16 EnGo2_GetStateGoronMarketBazaar(PlayState* play, EnGo2* this) {
    if (Message_GetState(&play->msgCtx) == TEXT_STATE_CLOSING) {
        return 0;
    } else {
        return 1;
...
u16 EnGo2_GetStateGoronCityLostWoods(PlayState* play, EnGo2* this) {
    if (Message_GetState(&play->msgCtx) == TEXT_STATE_CLOSING) {
...
u16 EnGo2_GetStateGoronDmtFairyHint(PlayState* play, EnGo2* this) {
    if (Message_GetState(&play->msgCtx) == TEXT_STATE_CLOSING) {
        return 0;
    } else {
        return 1;
...
s32 func_80A44790(EnGo2* this, PlayState* play) {
    if ((this->actor.params & 0x1F) != GORON_DMT_BIGGORON && (this->actor.params & 0x1F) != GORON_CITY_ROLLING_BIG) {
        ...
        if (Actor_ProcessTalkRequest(&this->actor, play)) {
            ...
            this->unk_194.unk_00 = EnGo2_GetState(play, this);
            return false;
    ...
    if ((this->actor.params & 0x1F) == GORON_DMT_BIGGORON) {
        ...
        if ((this->actionFunc != EnGo2_SlowRolling) && (this->actionFunc != EnGo2_ReverseRolling) &&
            ...
            if (this->collider.base.ocFlags2 & OC2_HIT_PLAYER) {
                ...
                Audio_PlayActorSfx2(player, NA_SE_PL_BODY_HIT);
                this->collider.base.ocFlags1 &= ~OC1_TYPE_PLAYER;
            }
        }
    }
