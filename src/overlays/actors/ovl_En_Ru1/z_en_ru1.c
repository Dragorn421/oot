...
void func_80AECCB0(EnRu1* this, GlobalContext* globalCtx) {
    ...
    this->blueWarp = (DoorWarp1*)Actor_SpawnAsChild(&globalCtx->actorCtx, this, globalCtx, ACTOR_DOOR_WARP1, spawnX,
...
s32 func_80AEE394(EnRu1* this, GlobalContext* globalCtx) {
    ...
    if ((this->actor.bgCheckFlags & BGCHECKFLAG_GROUND) && this->actor.floorBgId != BGCHECK_SCENE) {
        ...
        if (dynaActor != NULL && dynaActor->actor.id == ACTOR_BG_BDAN_OBJECTS && dynaActor->actor.params == 0 &&
            !Player_InCsMode(globalCtx) && globalCtx->msgCtx.msgLength == 0) {
            func_80AEE02C(this);
