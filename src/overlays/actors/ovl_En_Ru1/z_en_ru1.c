...
ColliderCylinderSrcAlt D_80AF0800 = {
    {
        COL_MATERIAL_HIT0,
        AT_NONE,
        AC_NONE,
...
ColliderCylinderSrcAlt D_80AF082C = {
    {
        COL_MATERIAL_HIT0,
...
void func_80AEAC54(EnRu1* this, GlobalContext* globalCtx) {
    ...
    Collider_UpdateCylinderShape(thisx, collider2);
    if (this->unk_34C != 0) {
        Collider_AddOC(globalCtx, &globalCtx->colliderCtx, collider2);
...
void func_80AEACDC(EnRu1* this, GlobalContext* globalCtx) {
    ...
    Collider_UpdateCylinderShape(&this->actor, collider2);
    Collider_AddAT(globalCtx, &globalCtx->colliderCtx, collider2);
}
...
void func_80AEAD20(EnRu1* this, GlobalContext* globalCtx) {
    ...
    Collider_LoadCylinderAlt(globalCtx, &this->collider, thisx, &D_80AF0800);

    Collider_InitCylinder(globalCtx, &this->collider2);
    Collider_LoadCylinderAlt(globalCtx, &this->collider2, thisx, &D_80AF082C);
}
