...
void func_808809E4(BgHakaTrap* this, PlayState* play, s16);
...
void BgHakaTrap_Draw(Actor* thisx, PlayState* play) {
    ...
    if (this->actionFunc == func_808802D8) {
        func_80026230(play, &D_8088103C, this->unk168 + 0x14, 0x28);
    }
    ...
    if ((this->actionFunc == func_808808F4) && ((u8)this->unk169 == 0)) {
        ...
        SkinMatrix_Vec3fMtxFMultXYZ(&play->viewProjectionMtxF, &sp2C, &this->unk16C);
        Sfx_PlaySfxAtPos(&this->unk16C, NA_SE_EV_BRIDGE_CLOSE - SFX_FLAG);
    }
}
