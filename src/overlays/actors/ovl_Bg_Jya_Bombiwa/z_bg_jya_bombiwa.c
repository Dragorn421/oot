...
void BgJyaBombiwa_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    BgJyaBombiwa_SetupDynaPoly(thisx, globalCtx, &gBombiwaCol, DPM_UNK);
...
void BgJyaBombiwa_Update(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if (this->collider.base.acFlags & AC_HIT) {
        ...
        SoundSource_PlaySfxAtFixedWorldPos(globalCtx, &this->dyna.actor.world, 40, NA_SE_EV_WALL_BROKEN);
