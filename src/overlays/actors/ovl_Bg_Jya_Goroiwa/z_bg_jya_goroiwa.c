...
static CollideDataInit sCollideDataInit = { 0x01, 0xF, 0x0, 0xFE };
...
void func_80897970(BgJyaGoroiwa* this) {
    Sphere16* worldSphere = &this->collider.elements[0].shape.world;
...
void func_808979C0(BgJyaGoroiwa* this, GlobalContext* globalCtx) {
    ...
    func_80897970(this);
    this->collider.elements[0].shape.world.radius = 0x3A;
}
