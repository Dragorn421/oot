...
typedef enum EnMbDamageReaction {
    /* 0x0 */ ENMB_DMG_REACTION_IGNORE,
    /* 0x1 */ ENMB_DMG_REACTION_STUN,
    /* 0x5 */ ENMB_DMG_REACTION_FREEZE = 0x5,
    /* 0x6 */ ENMB_DMG_REACTION_STUN_ICE,
    /* 0xF */ ENMB_DMG_REACTION_DEFAULT = 0xF
} EnMbDamageReaction;

static DamageTable sSpearMoblinDamageTable = {
    /* Deku nut      */ DMG_ENTRY(0, ENMB_DMG_REACTION_FREEZE),
    /* Deku stick    */ DMG_ENTRY(2, ENMB_DMG_REACTION_DEFAULT),
    /* Slingshot     */ DMG_ENTRY(1, ENMB_DMG_REACTION_DEFAULT),
    /* Explosive     */ DMG_ENTRY(2, ENMB_DMG_REACTION_DEFAULT),
    /* Boomerang     */ DMG_ENTRY(0, ENMB_DMG_REACTION_STUN),
    /* Normal arrow  */ DMG_ENTRY(2, ENMB_DMG_REACTION_DEFAULT),
    /* Hammer swing  */ DMG_ENTRY(2, ENMB_DMG_REACTION_DEFAULT),
    /* Hookshot      */ DMG_ENTRY(2, ENMB_DMG_REACTION_DEFAULT),
    /* Kokiri sword  */ DMG_ENTRY(1, ENMB_DMG_REACTION_DEFAULT),
    /* Master sword  */ DMG_ENTRY(2, ENMB_DMG_REACTION_DEFAULT),
    /* Giant's Knife */ DMG_ENTRY(4, ENMB_DMG_REACTION_DEFAULT),
    /* Fire arrow    */ DMG_ENTRY(2, ENMB_DMG_REACTION_DEFAULT),
    /* Ice arrow     */ DMG_ENTRY(4, ENMB_DMG_REACTION_STUN_ICE),
    /* Light arrow   */ DMG_ENTRY(2, ENMB_DMG_REACTION_DEFAULT),
    /* Unk arrow 1   */ DMG_ENTRY(4, ENMB_DMG_REACTION_DEFAULT),
    /* Unk arrow 2   */ DMG_ENTRY(2, ENMB_DMG_REACTION_DEFAULT),
    /* Unk arrow 3   */ DMG_ENTRY(2, ENMB_DMG_REACTION_DEFAULT),
    /* Fire magic    */ DMG_ENTRY(0, ENMB_DMG_REACTION_FREEZE),
    /* Ice magic     */ DMG_ENTRY(3, ENMB_DMG_REACTION_STUN_ICE),
    /* Light magic   */ DMG_ENTRY(0, ENMB_DMG_REACTION_FREEZE),
    /* Shield        */ DMG_ENTRY(0, ENMB_DMG_REACTION_IGNORE),
    /* Mirror Ray    */ DMG_ENTRY(0, ENMB_DMG_REACTION_IGNORE),
    /* Kokiri spin   */ DMG_ENTRY(1, ENMB_DMG_REACTION_DEFAULT),
    /* Giant spin    */ DMG_ENTRY(4, ENMB_DMG_REACTION_DEFAULT),
    /* Master spin   */ DMG_ENTRY(2, ENMB_DMG_REACTION_DEFAULT),
    /* Kokiri jump   */ DMG_ENTRY(2, ENMB_DMG_REACTION_DEFAULT),
    /* Giant jump    */ DMG_ENTRY(8, ENMB_DMG_REACTION_DEFAULT),
    /* Master jump   */ DMG_ENTRY(4, ENMB_DMG_REACTION_DEFAULT),
    /* Unknown 1     */ DMG_ENTRY(0, ENMB_DMG_REACTION_FREEZE),
    /* Unblockable   */ DMG_ENTRY(0, ENMB_DMG_REACTION_IGNORE),
    /* Hammer jump   */ DMG_ENTRY(4, ENMB_DMG_REACTION_DEFAULT),
    /* Unknown 2     */ DMG_ENTRY(0, ENMB_DMG_REACTION_IGNORE),
};

static DamageTable sClubMoblinDamageTable = {
    /* Deku nut      */ DMG_ENTRY(0, ENMB_DMG_REACTION_FREEZE),
    /* Deku stick    */ DMG_ENTRY(2, ENMB_DMG_REACTION_DEFAULT),
    /* Slingshot     */ DMG_ENTRY(0, ENMB_DMG_REACTION_IGNORE),
    /* Explosive     */ DMG_ENTRY(2, ENMB_DMG_REACTION_DEFAULT),
    /* Boomerang     */ DMG_ENTRY(0, ENMB_DMG_REACTION_IGNORE),
    /* Normal arrow  */ DMG_ENTRY(2, ENMB_DMG_REACTION_DEFAULT),
    /* Hammer swing  */ DMG_ENTRY(2, ENMB_DMG_REACTION_DEFAULT),
    /* Hookshot      */ DMG_ENTRY(0, ENMB_DMG_REACTION_STUN),
    /* Kokiri sword  */ DMG_ENTRY(1, ENMB_DMG_REACTION_DEFAULT),
    /* Master sword  */ DMG_ENTRY(2, ENMB_DMG_REACTION_DEFAULT),
    /* Giant's Knife */ DMG_ENTRY(4, ENMB_DMG_REACTION_DEFAULT),
    /* Fire arrow    */ DMG_ENTRY(2, ENMB_DMG_REACTION_DEFAULT),
...
void EnMb_SetupStunned(EnMb* this) {
    ...
    if (this->damageReaction == ENMB_DMG_REACTION_STUN_ICE) {
...
void EnMb_CheckColliding(EnMb* this, PlayState* play) {
    ...
    if (this->frontShieldingCollider.base.acFlags & AC_HIT) {
        ...
        this->bodyCollider.base.acFlags &= ~AC_HIT;
        if (this->actor.colChkInfo.damageReaction != ENMB_DMG_REACTION_IGNORE &&
            this->actor.colChkInfo.damageReaction != ENMB_DMG_REACTION_FREEZE) {
            if ((player->stateFlags2 & PLAYER_STATE2_7) && player->actor.parent == &this->actor) {
                player->stateFlags2 &= ~PLAYER_STATE2_7;
                player->actor.parent = NULL;
#if OOT_VERSION >= PAL_1_0
            ...
            if (this->actor.colChkInfo.damageReaction == ENMB_DMG_REACTION_STUN ||
                this->actor.colChkInfo.damageReaction == ENMB_DMG_REACTION_STUN_ICE) {
...
void EnMb_Update(Actor* thisx, PlayState* play) {
    ...
    if (thisx->colChkInfo.damageReaction != ENMB_DMG_REACTION_FREEZE) {
