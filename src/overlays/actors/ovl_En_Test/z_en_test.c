...
typedef enum StalfosDamageReaction {
    /* 0x0 */ STALFOS_DMG_REACTION_NORMAL,
    /* 0x1 */ STALFOS_DMG_REACTION_STUN,
    /* 0x6 */ STALFOS_DMG_REACTION_FIREMAGIC = 6,
    /* 0xD */ STALFOS_DMG_REACTION_SLING = 0xD,
    /* 0xE */ STALFOS_DMG_REACTION_LIGHT,
    /* 0xF */ STALFOS_DMG_REACTION_FREEZE
} StalfosDamageReaction;

static DamageTable sDamageTable = {
    /* Deku nut      */ DMG_ENTRY(0, STALFOS_DMG_REACTION_STUN),
    /* Deku stick    */ DMG_ENTRY(2, STALFOS_DMG_REACTION_NORMAL),
    /* Slingshot     */ DMG_ENTRY(1, STALFOS_DMG_REACTION_SLING),
    /* Explosive     */ DMG_ENTRY(2, STALFOS_DMG_REACTION_NORMAL),
    /* Boomerang     */ DMG_ENTRY(0, STALFOS_DMG_REACTION_STUN),
    /* Normal arrow  */ DMG_ENTRY(2, STALFOS_DMG_REACTION_NORMAL),
    /* Hammer swing  */ DMG_ENTRY(2, STALFOS_DMG_REACTION_NORMAL),
    /* Hookshot      */ DMG_ENTRY(0, STALFOS_DMG_REACTION_STUN),
    /* Kokiri sword  */ DMG_ENTRY(1, STALFOS_DMG_REACTION_NORMAL),
    /* Master sword  */ DMG_ENTRY(2, STALFOS_DMG_REACTION_NORMAL),
    /* Giant's Knife */ DMG_ENTRY(4, STALFOS_DMG_REACTION_NORMAL),
    /* Fire arrow    */ DMG_ENTRY(2, STALFOS_DMG_REACTION_NORMAL),
    /* Ice arrow     */ DMG_ENTRY(4, STALFOS_DMG_REACTION_FREEZE),
    /* Light arrow   */ DMG_ENTRY(2, STALFOS_DMG_REACTION_LIGHT),
    /* Unk arrow 1   */ DMG_ENTRY(2, STALFOS_DMG_REACTION_NORMAL),
    /* Unk arrow 2   */ DMG_ENTRY(2, STALFOS_DMG_REACTION_NORMAL),
    /* Unk arrow 3   */ DMG_ENTRY(2, STALFOS_DMG_REACTION_NORMAL),
    /* Fire magic    */ DMG_ENTRY(0, STALFOS_DMG_REACTION_FIREMAGIC),
    /* Ice magic     */ DMG_ENTRY(3, STALFOS_DMG_REACTION_FREEZE),
    /* Light magic   */ DMG_ENTRY(0, STALFOS_DMG_REACTION_LIGHT),
    /* Shield        */ DMG_ENTRY(0, STALFOS_DMG_REACTION_NORMAL),
    /* Mirror Ray    */ DMG_ENTRY(0, STALFOS_DMG_REACTION_NORMAL),
    /* Kokiri spin   */ DMG_ENTRY(1, STALFOS_DMG_REACTION_NORMAL),
    /* Giant spin    */ DMG_ENTRY(4, STALFOS_DMG_REACTION_NORMAL),
    /* Master spin   */ DMG_ENTRY(2, STALFOS_DMG_REACTION_NORMAL),
    /* Kokiri jump   */ DMG_ENTRY(2, STALFOS_DMG_REACTION_NORMAL),
    /* Giant jump    */ DMG_ENTRY(8, STALFOS_DMG_REACTION_NORMAL),
    /* Master jump   */ DMG_ENTRY(4, STALFOS_DMG_REACTION_NORMAL),
    /* Unknown 1     */ DMG_ENTRY(0, STALFOS_DMG_REACTION_NORMAL),
    /* Unblockable   */ DMG_ENTRY(0, STALFOS_DMG_REACTION_NORMAL),
    /* Hammer jump   */ DMG_ENTRY(4, STALFOS_DMG_REACTION_NORMAL),
    /* Unknown 2     */ DMG_ENTRY(0, STALFOS_DMG_REACTION_NORMAL),
};
...
void EnTest_SetupStunned(EnTest* this) {
    ...
    if (this->lastDamageReaction == STALFOS_DMG_REACTION_LIGHT) {
        ...
        if (this->lastDamageReaction == STALFOS_DMG_REACTION_FREEZE) {
            this->iceTimer = 36;
        } else {
...
void EnTest_UpdateDamage(EnTest* this, PlayState* play) {
    ...
    if (this->shieldCollider.base.acFlags & AC_BOUNCED) {
        ...
        if ((this->actor.colChkInfo.damageReaction != STALFOS_DMG_REACTION_SLING) &&
            (this->actor.colChkInfo.damageReaction != STALFOS_DMG_REACTION_FIREMAGIC)) {
            ...
            if ((this->actor.colChkInfo.damageReaction == STALFOS_DMG_REACTION_STUN) ||
                (this->actor.colChkInfo.damageReaction == STALFOS_DMG_REACTION_FREEZE) ||
                (this->actor.colChkInfo.damageReaction == STALFOS_DMG_REACTION_LIGHT)) {
                if (this->unk_7C8 != 0xB) {
...
void EnTest_Update(Actor* thisx, PlayState* play) {
    ...
    if (this->actor.colChkInfo.damageReaction != STALFOS_DMG_REACTION_FIREMAGIC) {
