...
void EnBom_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    thisx->collideData.mass = 200;
    thisx->collideData.unk_10 = 5;
    thisx->collideData.unk_12 = 0xA;
    this->timer = 70;
    ...
    Collider_LoadCylinder(globalCtx, &this->bombCollider, thisx, &sCylinderInit);
    Collider_LoadSpheres(globalCtx, &this->explosionCollider, thisx, &sJntSphInit, &this->explosionColliderItems[0]);
