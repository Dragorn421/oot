...
ColliderCylinderSrc sCylinderInit_EnDaiku = {
    {
        COL_MATERIAL_NONE,
        AT_NONE,
        AC_NONE,
...
static CollideDataInitAlt sCollideDataInit2 = { 0, 0, 0, 0, 0xFF };

static ActorDamageChart sActorDamageChart = { 0 };
...
void EnDaiku_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    Collider_LoadCylinder(globalCtx, &this->collider, &this->actor, &sCylinderInit_EnDaiku);
    func_80061EFC(&this->actor.collideData, &sActorDamageChart, &sCollideDataInit2);
