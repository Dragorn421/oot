...
void EnFirefly_Extinguish(EnFirefly* this) {
    this->actor.params += 2;
    this->collider.elements[0].base.toucher.effect_ColliderElementTouch = ACHITEFFECT_0; // None
...
void EnFirefly_Ignite(EnFirefly* this) {
    ...
    this->collider.elements[0].base.toucher.effect_ColliderElementTouch = ACHITEFFECT_1; // Fire
...
void EnFirefly_Init(Actor* thisx, PlayState* play) {
    ...
    if (this->onFire) {
        ...
        if (this->actor.params == KEESE_ICE_FLY) {
            this->collider.elements[0].base.toucher.effect_ColliderElementTouch = ACHITEFFECT_2; // Ice
            this->actor.naviEnemyId = NAVI_ENEMY_ICE_KEESE;
        } else {
            this->collider.elements[0].base.toucher.effect_ColliderElementTouch = ACHITEFFECT_0; // Nothing
            this->actor.naviEnemyId = NAVI_ENEMY_KEESE;
        }
