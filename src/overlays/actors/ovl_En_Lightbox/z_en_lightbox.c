...
void EnLightbox_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    thisx->collideData.unk_10 = 0x1E;
    thisx->collideData.unk_12 = 0x32;
...
void EnLightbox_Update(Actor* thisx, GlobalContext* globalCtx) {
    ...
    func_8002E4B4(globalCtx, thisx, thisx->collideData.unk_12, thisx->collideData.unk_10, thisx->collideData.unk_10, 0x1D);
    thisx->posRot2.pos = thisx->posRot.pos;
}
