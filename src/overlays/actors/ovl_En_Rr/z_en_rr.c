...
typedef enum EnRrDamageReaction {
    /* 0x0 */ RR_DMG_REACTION_NONE,
    /* 0x1 */ RR_DMG_REACTION_STUN,
    /* 0x2 */ RR_DMG_REACTION_FIRE,
    /* 0x3 */ RR_DMG_REACTION_ICE,
    /* 0x4 */ RR_DMG_REACTION_LIGHT_MAGIC,
    /* 0xB */ RR_DMG_REACTION_LIGHT_ARROW = 11,
    /* 0xC */ RR_DMG_REACTION_SHDW_ARROW,
    /* 0xD */ RR_DMG_REACTION_WIND_ARROW,
    /* 0xE */ RR_DMG_REACTION_SPRT_ARROW,
    /* 0xF */ RR_DMG_REACTION_NORMAL
} EnRrDamageReaction;
...
static DamageTable sDamageTable = {
    /* Deku nut      */ DMG_ENTRY(0, RR_DMG_REACTION_NONE),
    /* Deku stick    */ DMG_ENTRY(2, RR_DMG_REACTION_NORMAL),
    /* Slingshot     */ DMG_ENTRY(1, RR_DMG_REACTION_NORMAL),
    /* Explosive     */ DMG_ENTRY(2, RR_DMG_REACTION_NORMAL),
    /* Boomerang     */ DMG_ENTRY(0, RR_DMG_REACTION_STUN),
    /* Normal arrow  */ DMG_ENTRY(2, RR_DMG_REACTION_NORMAL),
    /* Hammer swing  */ DMG_ENTRY(2, RR_DMG_REACTION_NORMAL),
    /* Hookshot      */ DMG_ENTRY(0, RR_DMG_REACTION_STUN),
    /* Kokiri sword  */ DMG_ENTRY(1, RR_DMG_REACTION_NORMAL),
    /* Master sword  */ DMG_ENTRY(2, RR_DMG_REACTION_NORMAL),
    /* Giant's Knife */ DMG_ENTRY(4, RR_DMG_REACTION_NORMAL),
    /* Fire arrow    */ DMG_ENTRY(4, RR_DMG_REACTION_FIRE),
    /* Ice arrow     */ DMG_ENTRY(4, RR_DMG_REACTION_ICE),
    /* Light arrow   */ DMG_ENTRY(15, RR_DMG_REACTION_LIGHT_ARROW),
    /* Unk arrow 1   */ DMG_ENTRY(4, RR_DMG_REACTION_WIND_ARROW),
    /* Unk arrow 2   */ DMG_ENTRY(15, RR_DMG_REACTION_SHDW_ARROW),
    /* Unk arrow 3   */ DMG_ENTRY(15, RR_DMG_REACTION_SPRT_ARROW),
    /* Fire magic    */ DMG_ENTRY(4, RR_DMG_REACTION_FIRE),
    /* Ice magic     */ DMG_ENTRY(3, RR_DMG_REACTION_ICE),
    /* Light magic   */ DMG_ENTRY(10, RR_DMG_REACTION_LIGHT_MAGIC),
    /* Shield        */ DMG_ENTRY(0, RR_DMG_REACTION_NONE),
    /* Mirror Ray    */ DMG_ENTRY(0, RR_DMG_REACTION_NONE),
    /* Kokiri spin   */ DMG_ENTRY(1, RR_DMG_REACTION_NORMAL),
    /* Giant spin    */ DMG_ENTRY(4, RR_DMG_REACTION_NORMAL),
    /* Master spin   */ DMG_ENTRY(2, RR_DMG_REACTION_NORMAL),
    /* Kokiri jump   */ DMG_ENTRY(2, RR_DMG_REACTION_NORMAL),
    /* Giant jump    */ DMG_ENTRY(8, RR_DMG_REACTION_NORMAL),
    /* Master jump   */ DMG_ENTRY(4, RR_DMG_REACTION_NORMAL),
    /* Unknown 1     */ DMG_ENTRY(10, RR_DMG_REACTION_SPRT_ARROW),
    /* Unblockable   */ DMG_ENTRY(0, RR_DMG_REACTION_NONE),
    /* Hammer jump   */ DMG_ENTRY(0, RR_DMG_REACTION_NONE),
    /* Unknown 2     */ DMG_ENTRY(0, RR_DMG_REACTION_NONE),
};
    ...
    if (this->collider2.base.acFlags & AC_HIT) {
        ...
        if (this->collider1.base.acFlags & AC_HIT) {
            ...
            switch (this->actor.colChkInfo.damageReaction) {
                case RR_DMG_REACTION_LIGHT_ARROW:
                    dropType++; // purple rupee
                    FALLTHROUGH;
                case RR_DMG_REACTION_SHDW_ARROW:
                    dropType++; // flexible
                    FALLTHROUGH;
                case RR_DMG_REACTION_WIND_ARROW:
                    dropType++; // arrow
                    FALLTHROUGH;
                case RR_DMG_REACTION_SPRT_ARROW:
                    dropType++; // magic jar
                    FALLTHROUGH;
                case RR_DMG_REACTION_NORMAL:
                    // "ouch"
                    ...
                    return;
                case RR_DMG_REACTION_FIRE: // Fire Arrow and Din's Fire
                    Actor_ApplyDamage(&this->actor);
                    ...
                    return;
                case RR_DMG_REACTION_ICE: // Ice Arrow and unused ice magic
                    Actor_ApplyDamage(&this->actor);
                    if (this->actor.colChkInfo.health == 0) {
                        this->dropType = RR_DROP_RANDOM_RUPEE;
                    }
                    ...
                    EnRr_SetupStunned(this);
                    return;
                case RR_DMG_REACTION_LIGHT_MAGIC: // Unused light magic
                    Actor_ApplyDamage(&this->actor);
                    if (this->actor.colChkInfo.health == 0) {
                    ...
                    EnRr_SetupStunned(this);
                    return;
                case RR_DMG_REACTION_STUN: // Boomerang and Hookshot
