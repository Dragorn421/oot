...
void EnHeishi4_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    Collider_LoadCylinder(globalCtx, &this->collider, thisx, &sCylinderInit);
    this->collider.shape.yShift = 0;
    this->collider.shape.radius = 15;
    this->collider.shape.height = 70;
    switch (this->type) {
        ...
        case HEISHI4_AT_MARKET_DYING:
            this->collider.shape.radius = 28;
            this->collider.shape.height = 5;
