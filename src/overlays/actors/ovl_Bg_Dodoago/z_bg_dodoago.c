...
static ColliderCylinderSrc sColCylinderInit0 = {
    {
        COL_MATERIAL_NONE,
        AT_NONE,
        AC_ON | AC_TYPE_ALL,
...
static ColliderCylinderSrc sColCylinderInit1 = {
    {
        COL_MATERIAL_NONE,
        AT_NONE,
        AC_NONE,
...
void BgDodoago_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    Collider_LoadCylinder(globalCtx, &this->colliders[0], &this->dyna.actor, &sColCylinderInit0);
    Collider_LoadCylinder(globalCtx, &this->colliders[1], &this->dyna.actor, &sColCylinderInit1);
    Collider_LoadCylinder(globalCtx, &this->colliders[2], &this->dyna.actor, &sColCylinderInit1);
...
void func_80871CF4(BgDodoago* this, GlobalContext* globalCtx) {
    ...
    if (explosive != NULL) {
        ...
        if (Flags_GetEventChkInf(0xB0)) {
            Collider_UpdateCylinderShape(&this->dyna.actor, &this->colliders[0]);
            Collider_UpdateCylinderShape(&this->dyna.actor, &this->colliders[1]);
            Collider_UpdateCylinderShape(&this->dyna.actor, &this->colliders[2]);
            this->colliders[0].shape.pos.z += 0xC8;
            this->colliders[1].shape.pos.z += 0xD7;
            this->colliders[1].shape.pos.x += 0x5A;
            this->colliders[2].shape.pos.z += 0xD7;
            this->colliders[2].shape.pos.x -= 0x5A;

            Collider_AddAC(globalCtx, &globalCtx->colliderCtx, &this->colliders[0].base);
            Collider_AddOC(globalCtx, &globalCtx->colliderCtx, &this->colliders[1].base);
            Collider_AddOC(globalCtx, &globalCtx->colliderCtx, &this->colliders[2].base);
        }
    }
}
...
void BgDodoago_Update(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if (this->dyna.actor.parent == NULL) {
        if ((s32)(this->colliders[1].base.ocFlags1 & 2) || (this->colliders[2].base.ocFlags1 & 2)) {

            if ((s32)(this->colliders[1].base.ocFlags1 & 2)) {
                bomb = (EnBom*)this->colliders[1].base.oc;
            } else {
                bomb = (EnBom*)this->colliders[2].base.oc;
            }
            this->colliders[1].base.ocFlags1 &= ~2;
            this->colliders[2].base.ocFlags1 &= ~2;
