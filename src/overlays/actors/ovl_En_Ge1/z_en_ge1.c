...
void EnGe1_TalkAfterGame_Archery(EnGe1* this, PlayState* play) {
    ...
    LOG_NUM("z_common_data.yabusame_total", GET_MINIGAME_SCORE, "../z_en_ge1.c", 1110);
    ...
    if (HIGH_SCORE(HS_HBA) < GET_MINIGAME_SCORE) {
        HIGH_SCORE(HS_HBA) = GET_MINIGAME_SCORE;
    }
    ...
    } else if (GET_MINIGAME_SCORE < 1500) {
