...
static ColliderSpheresElementSrc sColliderItemInit[1] = {
    {
        {
            ELEM_MATERIAL_UNK0,
            {
...
static ColliderSpheresSrc sColliderInit = {
    {
        COL_MATERIAL_NONE,
        AT_NONE,
        AC_NONE,
...
void EnButte_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    Collider_LoadSpheres(globalCtx, &this->collider, &this->actor, &sColliderInit, this->colliderItems);
