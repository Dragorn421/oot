...
u16 EnKz_GetText(PlayState* play, EnKz* this) {
...
s16 func_80A9C6C0(PlayState* play, EnKz* this) {
    s32 pad;
...
s32 func_80A9C95C(PlayState* play, EnKz* this, s16* talkState, f32 unkf, NpcGetTextIdFunc getTextId,
    ...
    if (*talkState != NPC_TALK_STATE_IDLE) {
        *talkState = updateTalkState(play, this);
        return 0;
    }
    ...
    this->actor.xzDistToPlayer = xzDistToPlayer;
    this->actor.textId = getTextId(play, this);
...
void func_80A9CB18(EnKz* this, PlayState* play) {
    ...
    if (func_80A9C95C(play, this, &this->interactInfo.talkState, 340.0f, EnKz_GetText, func_80A9C6C0) != 0) {
