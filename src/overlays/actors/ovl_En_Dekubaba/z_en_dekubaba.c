...
typedef enum DekuBabaDamageReaction {
    /* 0x0 */ DEKUBABA_DMG_REACTION_NONE,
    /* 0x1 */ DEKUBABA_DMG_REACTION_DEKUNUT,
    /* 0x2 */ DEKUBABA_DMG_REACTION_FIRE,
    /* 0xE */ DEKUBABA_DMG_REACTION_BOOMERANG = 14,
    /* 0xF */ DEKUBABA_DMG_REACTION_SWORD
} DekuBabaDamageReaction;

static DamageTable sDekuBabaDamageTable = {
    /* Deku nut      */ DMG_ENTRY(0, DEKUBABA_DMG_REACTION_DEKUNUT),
    /* Deku stick    */ DMG_ENTRY(2, DEKUBABA_DMG_REACTION_NONE),
    /* Slingshot     */ DMG_ENTRY(1, DEKUBABA_DMG_REACTION_NONE),
    /* Explosive     */ DMG_ENTRY(2, DEKUBABA_DMG_REACTION_NONE),
    /* Boomerang     */ DMG_ENTRY(2, DEKUBABA_DMG_REACTION_BOOMERANG),
    /* Normal arrow  */ DMG_ENTRY(2, DEKUBABA_DMG_REACTION_NONE),
    /* Hammer swing  */ DMG_ENTRY(2, DEKUBABA_DMG_REACTION_NONE),
    /* Hookshot      */ DMG_ENTRY(2, DEKUBABA_DMG_REACTION_NONE),
    /* Kokiri sword  */ DMG_ENTRY(1, DEKUBABA_DMG_REACTION_SWORD),
    /* Master sword  */ DMG_ENTRY(2, DEKUBABA_DMG_REACTION_SWORD),
    /* Giant's Knife */ DMG_ENTRY(4, DEKUBABA_DMG_REACTION_SWORD),
    /* Fire arrow    */ DMG_ENTRY(4, DEKUBABA_DMG_REACTION_FIRE),
    /* Ice arrow     */ DMG_ENTRY(2, DEKUBABA_DMG_REACTION_NONE),
    /* Light arrow   */ DMG_ENTRY(2, DEKUBABA_DMG_REACTION_NONE),
    /* Unk arrow 1   */ DMG_ENTRY(2, DEKUBABA_DMG_REACTION_NONE),
    /* Unk arrow 2   */ DMG_ENTRY(2, DEKUBABA_DMG_REACTION_NONE),
    /* Unk arrow 3   */ DMG_ENTRY(2, DEKUBABA_DMG_REACTION_NONE),
    /* Fire magic    */ DMG_ENTRY(4, DEKUBABA_DMG_REACTION_FIRE),
    /* Ice magic     */ DMG_ENTRY(0, DEKUBABA_DMG_REACTION_NONE),
    /* Light magic   */ DMG_ENTRY(0, DEKUBABA_DMG_REACTION_NONE),
    /* Shield        */ DMG_ENTRY(0, DEKUBABA_DMG_REACTION_NONE),
    /* Mirror Ray    */ DMG_ENTRY(0, DEKUBABA_DMG_REACTION_NONE),
    /* Kokiri spin   */ DMG_ENTRY(1, DEKUBABA_DMG_REACTION_SWORD),
    /* Giant spin    */ DMG_ENTRY(4, DEKUBABA_DMG_REACTION_SWORD),
    /* Master spin   */ DMG_ENTRY(2, DEKUBABA_DMG_REACTION_SWORD),
    /* Kokiri jump   */ DMG_ENTRY(2, DEKUBABA_DMG_REACTION_SWORD),
    /* Giant jump    */ DMG_ENTRY(8, DEKUBABA_DMG_REACTION_SWORD),
    /* Master jump   */ DMG_ENTRY(4, DEKUBABA_DMG_REACTION_SWORD),
    /* Unknown 1     */ DMG_ENTRY(0, DEKUBABA_DMG_REACTION_NONE),
    /* Unblockable   */ DMG_ENTRY(0, DEKUBABA_DMG_REACTION_NONE),
    /* Hammer jump   */ DMG_ENTRY(4, DEKUBABA_DMG_REACTION_NONE),
    /* Unknown 2     */ DMG_ENTRY(0, DEKUBABA_DMG_REACTION_NONE),
};
...
static DamageTable sBigDekuBabaDamageTable = {
    ...
    /* Normal arrow  */ DMG_ENTRY(2, DEKUBABA_DMG_REACTION_NONE),
    /* Hammer swing  */ DMG_ENTRY(2, DEKUBABA_DMG_REACTION_NONE),
    /* Hookshot      */ DMG_ENTRY(0, DEKUBABA_DMG_REACTION_DEKUNUT),
    /* Kokiri sword  */ DMG_ENTRY(1, DEKUBABA_DMG_REACTION_SWORD),
    /* Master sword  */ DMG_ENTRY(2, DEKUBABA_DMG_REACTION_SWORD),
    /* Giant's Knife */ DMG_ENTRY(4, DEKUBABA_DMG_REACTION_SWORD),
    /* Fire arrow    */ DMG_ENTRY(4, DEKUBABA_DMG_REACTION_FIRE),
...
void EnDekubaba_Init(Actor* thisx, PlayState* play) {
    ...
    if (this->actor.params == DEKUBABA_BIG) {
        ...
        if (!LINK_IS_ADULT) {
            sBigDekuBabaDamageTable.table[0x1B] = DMG_ENTRY(4, DEKUBABA_DMG_REACTION_NONE); // DMG_JUMP_MASTER
        }
        ...
        if (!LINK_IS_ADULT) {
            sDekuBabaDamageTable.table[0x1B] = DMG_ENTRY(4, DEKUBABA_DMG_REACTION_NONE); // DMG_JUMP_MASTER
        }
...
void EnDekubaba_UpdateDamage(EnDekubaba* this, PlayState* play) {
    ...
    if (this->collider.base.acFlags & AC_HIT) {
        ...
        if ((this->collider.base.colMaterial != COL_MATERIAL_HARD) &&
            ((this->actor.colChkInfo.damageReaction != DEKUBABA_DMG_REACTION_NONE) ||
             (this->actor.colChkInfo.damage != 0))) {

            phi_s0 = this->actor.colChkInfo.health - this->actor.colChkInfo.damage;

            if (this->actionFunc != EnDekubaba_StunnedVertical) {
                if ((this->actor.colChkInfo.damageReaction == DEKUBABA_DMG_REACTION_BOOMERANG) ||
                    (this->actor.colChkInfo.damageReaction == DEKUBABA_DMG_REACTION_DEKUNUT)) {
                    if (this->actor.colChkInfo.damageReaction == DEKUBABA_DMG_REACTION_BOOMERANG) {
            ...
            } else if ((this->actor.colChkInfo.damageReaction == DEKUBABA_DMG_REACTION_BOOMERANG) ||
                       (this->actor.colChkInfo.damageReaction == DEKUBABA_DMG_REACTION_SWORD)) {
                if (phi_s0 > 0) {
                    EnDekubaba_SetupSway(this);
                } else {
                    EnDekubaba_SetupPrunedSomersault(this);
                }
            } else if (this->actor.colChkInfo.damageReaction != DEKUBABA_DMG_REACTION_DEKUNUT) {
                EnDekubaba_SetupHit(this, 0);
            } else {
                return;
            }
            ...
            if (this->actor.colChkInfo.damageReaction == DEKUBABA_DMG_REACTION_FIRE) {
