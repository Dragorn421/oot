...
void EnCow_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    switch (this->actor.params) {
        case 0:
            ...
            Collider_LoadCylinder(globalCtx, &this->colliders[0], &this->actor, &sCylinderInit);
            Collider_InitCylinder(globalCtx, &this->colliders[1]);
            Collider_LoadCylinder(globalCtx, &this->colliders[1], &this->actor, &sCylinderInit);
            func_809DEE9C(this);
...
void EnCow_Update(Actor* thisx, GlobalContext* globalCtx) {
    ...
    Collider_AddOC(globalCtx, &globalCtx->colliderCtx, &this->colliders[0].base);
