...
s16 EnGo_SetFlagsGetStates(PlayState* play, EnGo* this) {
    s16 unkState = 1;
    f32 xzRange;
        ...
        case TEXT_STATE_CLOSING:
            switch (this->actor.textId) {
                ...
                case 0x3018:
                    ...
                    break;
                case 0x3036:
                    func_8002F434(&this->actor, play, GI_TUNIC_GORON, xzRange, yRange);
...
void func_80A3F908(EnGo* this, PlayState* play) {
    ...
    if (this->actionFunc == EnGo_BiggoronActionFunc || this->actionFunc == EnGo_GoronLinkRolling ||
        ...
        if ((this->actor.params & 0xF0) == 0x90) {
            isUnkCondition =
                func_80A3ED24(play, &this->actor, &this->unk_1E0, float1, EnGo_GetTextID, EnGo_SetFlagsGetStates);
        } else {
            isUnkCondition =
                func_800343CC(play, &this->actor, &this->unk_1E0, float1, EnGo_GetTextID, EnGo_SetFlagsGetStates);
        }
...
void EnGo_GetItem(EnGo* this, PlayState* play) {
    ...
    if (Actor_HasParent(&this->actor, play)) {
        ...
        func_8002F434(&this->actor, play, getItem, xzDist, yDist);
    }
}
