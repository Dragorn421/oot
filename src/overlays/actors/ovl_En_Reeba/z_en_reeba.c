...
void EnReeba_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if (this->isBig) {
        ...
        this->collider.shape.height = 45;
        this->scale *= 1.5f;
        osSyncPrintf(VT_FGCOL(YELLOW) "☆☆☆☆☆ リーバぼす登場 ☆☆☆☆☆ %f\n" VT_RST, this->scale);
        this->actor.collideData.health = 20;
        this->collider.elem.atDmgInfo.hitSpecialEffect = 4;
...
void func_80AE5938(EnReeba* this, GlobalContext* globalCtx) {
    ...
    if (this->unk_278 != 0) {
        ...
        if ((this->unk_27E == 4) || (this->actor.collideData.health != 0)) {
            if (this->unk_27E == 2) {
    ...
    if (this->collider.base.acFlags & 2) {
        ...
        if ((this->actionfunc != func_80AE5C38) && (this->actionfunc != func_80AE5854)) {
            ...
            switch (this->actor.collideData.damageEffect) {
                case 11: // none
                case 12: // boomerang
                    if ((this->actor.collideData.health > 1) && (this->unk_27E != 4)) {
                        this->unk_27E = 4;
                ...
                case 13: // hookshot/longshot
                    if ((this->actor.collideData.health > 2) && (this->unk_27E != 4)) {
                        this->unk_27E = 4;
                        func_8003426C(&this->actor, 0, 0xFF, 0, 0x50);
                        Audio_PlayActorSound2(&this->actor, NA_SE_EN_GOMA_JR_FREEZE);
                        this->actionfunc = func_80AE58EC;
...
void EnReeba_Update(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if ((this->actor.shape.unk_08 >= -700.0f) && (this->actor.collideData.health > 0) &&
        (this->actionfunc != func_80AE56E0)) {
