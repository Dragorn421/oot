...
void EnBombf_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    Collider_LoadCylinder(globalCtx, &this->bombCollider, thisx, &sCylinderInit_EnBombf);
    Collider_LoadSpheres(globalCtx, &this->explosionCollider, thisx, &sJntSphInit_EnBombf, &this->explosionColliderItems[0]);
    ...
    thisx->collideData.unk_10 = 10.0f;
    thisx->collideData.unk_12 = 10;
    thisx->unk_1F = 0;
