...
typedef enum AnubiceDamageReaction {
    /* 0x0 */ ANUBICE_DMG_REACTION_NONE,
    /* 0x2 */ ANUBICE_DMG_REACTION_FIRE = 2,
    /* 0xF */ ANUBICE_DMG_REACTION_0xF = 0xF // Treated the same as ANUBICE_DMG_REACTION_NONE in code
} AnubiceDamageReaction;

static DamageTable sDamageTable[] = {
    /* Deku nut      */ DMG_ENTRY(0, ANUBICE_DMG_REACTION_NONE),
    /* Deku stick    */ DMG_ENTRY(0, ANUBICE_DMG_REACTION_0xF),
    /* Slingshot     */ DMG_ENTRY(0, ANUBICE_DMG_REACTION_0xF),
    /* Explosive     */ DMG_ENTRY(0, ANUBICE_DMG_REACTION_0xF),
    /* Boomerang     */ DMG_ENTRY(0, ANUBICE_DMG_REACTION_0xF),
    /* Normal arrow  */ DMG_ENTRY(0, ANUBICE_DMG_REACTION_0xF),
    /* Hammer swing  */ DMG_ENTRY(1, ANUBICE_DMG_REACTION_0xF),
    /* Hookshot      */ DMG_ENTRY(2, ANUBICE_DMG_REACTION_0xF),
    /* Kokiri sword  */ DMG_ENTRY(0, ANUBICE_DMG_REACTION_0xF),
    /* Master sword  */ DMG_ENTRY(2, ANUBICE_DMG_REACTION_0xF),
    /* Giant's Knife */ DMG_ENTRY(6, ANUBICE_DMG_REACTION_0xF),
    /* Fire arrow    */ DMG_ENTRY(2, ANUBICE_DMG_REACTION_FIRE),
    /* Ice arrow     */ DMG_ENTRY(0, ANUBICE_DMG_REACTION_0xF),
    /* Light arrow   */ DMG_ENTRY(0, ANUBICE_DMG_REACTION_0xF),
    /* Unk arrow 1   */ DMG_ENTRY(0, ANUBICE_DMG_REACTION_0xF),
    /* Unk arrow 2   */ DMG_ENTRY(0, ANUBICE_DMG_REACTION_0xF),
    /* Unk arrow 3   */ DMG_ENTRY(0, ANUBICE_DMG_REACTION_0xF),
    /* Fire magic    */ DMG_ENTRY(3, ANUBICE_DMG_REACTION_FIRE),
    /* Ice magic     */ DMG_ENTRY(0, ANUBICE_DMG_REACTION_NONE),
    /* Light magic   */ DMG_ENTRY(0, ANUBICE_DMG_REACTION_NONE),
    /* Shield        */ DMG_ENTRY(0, ANUBICE_DMG_REACTION_NONE),
    /* Mirror Ray    */ DMG_ENTRY(0, ANUBICE_DMG_REACTION_NONE),
    /* Kokiri spin   */ DMG_ENTRY(0, ANUBICE_DMG_REACTION_0xF),
    /* Giant spin    */ DMG_ENTRY(6, ANUBICE_DMG_REACTION_0xF),
    /* Master spin   */ DMG_ENTRY(2, ANUBICE_DMG_REACTION_0xF),
    /* Kokiri jump   */ DMG_ENTRY(0, ANUBICE_DMG_REACTION_0xF),
    /* Giant jump    */ DMG_ENTRY(12, ANUBICE_DMG_REACTION_0xF),
    /* Master jump   */ DMG_ENTRY(4, ANUBICE_DMG_REACTION_0xF),
    /* Unknown 1     */ DMG_ENTRY(0, ANUBICE_DMG_REACTION_NONE),
    /* Unblockable   */ DMG_ENTRY(0, ANUBICE_DMG_REACTION_NONE),
    /* Hammer jump   */ DMG_ENTRY(0, ANUBICE_DMG_REACTION_NONE),
    /* Unknown 2     */ DMG_ENTRY(0, ANUBICE_DMG_REACTION_NONE),
};
...
void EnAnubice_Update(Actor* thisx, PlayState* play) {
    ...
    if ((this->actionFunc != EnAnubice_SetupDie) && (this->actionFunc != EnAnubice_Die) &&
        ...
        if (this->collider.base.acFlags & AC_HIT) {
            ...
            if (this->actor.colChkInfo.damageReaction == ANUBICE_DMG_REACTION_FIRE) {
                Actor_ChangeCategory(play, &play->actorCtx, &this->actor, ACTORCAT_PROP);
                this->actor.flags &= ~ACTOR_FLAG_ATTENTION_ENABLED;
                Enemy_StartFinishingBlow(play, &this->actor);
                Actor_PlaySfx(&this->actor, NA_SE_EN_ANUBIS_DEAD);
