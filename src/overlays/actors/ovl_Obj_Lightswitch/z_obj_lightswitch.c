...
static ColliderSpheresElementSrc sColliderSpheresElementSrc[1] = {
    {
        {
            ELEM_MATERIAL_UNK0,
            {
...
static ColliderSpheresSrc sColliderSpheresSrc = {
    {
        COL_MATERIAL_NONE,
        AT_NONE,
    ...
    1,
    sColliderSpheresElementSrc,
};
static CollideDataInit sCollideDataInit = { 0, 0xC, 0x3C, 0xFF };
...
void ObjLightswitch_InitCollider(ObjLightswitch* this, GlobalContext* globalCtx) {
    ...
    Collider_LoadSpheres(globalCtx, &this->collider, &this->actor, &sColliderSpheresSrc, this->colliderItems);
...
void ObjLightswitch_Destroy(Actor* thisx, GlobalContext* globalCtx) {
    ...
    Collider_DestroySpheres(globalCtx2, &this->collider);
}
...
void ObjLightswitch_Update(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if (this->actor.update != NULL) {
        ...
        Collider_AddOC(globalCtx2, &globalCtx2->colliderCtx, &this->collider.base);
        Collider_AddAC(globalCtx2, &globalCtx2->colliderCtx, &this->collider.base);
    }
}
