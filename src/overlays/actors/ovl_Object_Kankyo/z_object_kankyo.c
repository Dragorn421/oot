    ...
    switch (this->actor.params) {
        ...
        case 5:
            ...
            if (GET_CUTSCENE_TRIGGER != 0) {
                if (GET_ENTRANCE_INDEX == ENTR_GANONTIKA_2) {
                    this->effects[0].size = 0.1f;
                }
                if (GET_ENTRANCE_INDEX == ENTR_GANONTIKA_3) {
                    this->effects[1].size = 0.1f;
                }
                if (GET_ENTRANCE_INDEX == ENTR_GANONTIKA_4) {
                    this->effects[2].size = 0.1f;
                }
                if (GET_ENTRANCE_INDEX == ENTR_GANONTIKA_5) {
                    this->effects[3].size = 0.1f;
                }
                if (GET_ENTRANCE_INDEX == ENTR_GANONTIKA_6) {
                    this->effects[4].size = 0.1f;
                }
                if (GET_ENTRANCE_INDEX == ENTR_GANONTIKA_7) {
...
void ObjectKankyo_Fairies(ObjectKankyo* this, PlayState* play) {
    ...
    if (play->sceneId == SCENE_SPOT04 && GET_SCENE_LAYER == 7) {
    ...
    if (play->envCtx.precipitation[PRECIP_SNOW_MAX] < 64 &&
        (GET_ENTRANCE_INDEX != ENTR_SPOT04_0 || GET_SCENE_LAYER != 4 ||
