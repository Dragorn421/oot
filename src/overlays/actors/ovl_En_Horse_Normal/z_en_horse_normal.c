...
static CollideDataInit sCollideDataInit = { 10, 35, 100, 0xFE };
...
void EnHorseNormal_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    Collider_LoadCylinder(globalCtx, &this->bodyCollider, &this->actor, &sCylinderInit1);
    ...
    Collider_LoadCylinder(globalCtx, &this->cloneCollider, &this->actor, &sCylinderInit2);
...
void EnHorseNormal_Wander(EnHorseNormal* this, GlobalContext* globalCtx) {
    ...
    switch (D_80A6D510[this->animationIdx]) {
        ...
        case 1:
            ...
            if (Math_Rand_ZeroOne() < 0.1f ||
                (this->unk_21E == 0 && (this->actor.bgCheckFlags & 8 || this->bodyCollider.base.ocFlags1 & 2 ||
                                        this->headCollider.base.ocFlags1 & 2))) {
...
void EnHorseNormal_Draw(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if (this->action == HORSE_WAIT_CLONE) {
        ...
        this->cloneCollider.shape.pos.x = clonePos.x;
        this->cloneCollider.shape.pos.y = clonePos.y;
        this->cloneCollider.shape.pos.z = clonePos.z;
        Collider_AddOC(globalCtx, &globalCtx->colliderCtx, &this->cloneCollider.base);
