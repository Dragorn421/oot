...
void BgMoriHashigo_InitCollider(BgMoriHashigo* this, GlobalContext* globalCtx) {
    ...
    Collider_LoadSpheres(globalCtx, &this->collider, &this->dyna.actor, &sJntSphInit, this->colliderItems);

    this->collider.elements[0].shape.world.center.x = (s16)this->dyna.actor.posRot.pos.x;
    this->collider.elements[0].shape.world.center.y = (s16)this->dyna.actor.posRot.pos.y + 21;
    this->collider.elements[0].shape.world.center.z = (s16)this->dyna.actor.posRot.pos.z;
    this->collider.elements[0].shape.world.radius = 19;
}
