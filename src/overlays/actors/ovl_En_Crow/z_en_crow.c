...
static CollideDataInit sCollideDataInit = { 1, 0x000F, 0x001E, 30 };
...
void func_809E03B4(EnCrow* this, GlobalContext* globalCtx) {
    ...
    } else if (this->actor.collideData.damageEffect == 2) {
...
void func_809E0770(EnCrow* this) {
    if (sDeathCount == 10) {
        this->actor.params = 1;
        sDeathCount = 0;
        this->collider.elements[0].shape.world.radius = sJntSphInit.elements[0].shape.unk2.radius * 0.03f * 100.0f;
    } else {
        this->actor.params = 0;
        this->collider.elements[0].shape.world.radius = sJntSphInit.elements[0].shape.unk2.radius;
    }
...
void func_809E1174(EnCrow* this, GlobalContext* globalCtx) {
    if (this->collider.base.acFlags & 2) {
        ...
        func_80035650(&this->actor, &this->collider.elements[0].base, 1);
...
void EnCrow_Update(Actor* thisx, GlobalContext* globalCtx) {
    ...
    this->collider.elements[0].shape.world.center.y = this->actor.posRot.pos.y + height;
    ...
    if (this->actor.collideData.health != 0 && Animation_OnFrame(&this->skelAnime, 3.0f)) {
