...
void func_808B2180(BgSpot11Bakudankabe* this, GlobalContext* globalCtx) {
    ...
    Collider_LoadCylinder(globalCtx, &this->collider, &this->dyna.actor, &sCylinderInit);
    this->collider.shape.pos.x += (s16)this->dyna.actor.posRot.pos.x;
    this->collider.shape.pos.y += (s16)this->dyna.actor.posRot.pos.y;
    this->collider.shape.pos.z += (s16)this->dyna.actor.posRot.pos.z;
}
