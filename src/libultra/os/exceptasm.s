...
endrcp:
    ...
    sdc1    $f0, THREAD_FPREGS(0)($k0)
    sdc1    $f1, THREAD_FPREGS(1)($k0)
    sdc1    $f2, THREAD_FPREGS(2)($k0)
    sdc1    $f3, THREAD_FPREGS(3)($k0)
    sdc1    $f4, THREAD_FPREGS(4)($k0)
    sdc1    $f5, THREAD_FPREGS(5)($k0)
    sdc1    $f6, THREAD_FPREGS(6)($k0)
    sdc1    $f7, THREAD_FPREGS(7)($k0)
    sdc1    $f8, THREAD_FPREGS(8)($k0)
    sdc1    $f9, THREAD_FPREGS(9)($k0)
    sdc1    $f10, THREAD_FPREGS(10)($k0)
    sdc1    $f11, THREAD_FPREGS(11)($k0)
    sdc1    $f12, THREAD_FPREGS(12)($k0)
    sdc1    $f13, THREAD_FPREGS(13)($k0)
    sdc1    $f14, THREAD_FPREGS(14)($k0)
    sdc1    $f15, THREAD_FPREGS(15)($k0)
    sdc1    $f16, THREAD_FPREGS(16)($k0)
    sdc1    $f17, THREAD_FPREGS(17)($k0)
    sdc1    $f18, THREAD_FPREGS(18)($k0)
    sdc1    $f19, THREAD_FPREGS(19)($k0)
    sdc1    $f20, THREAD_FPREGS(20)($k0)
    sdc1    $f21, THREAD_FPREGS(21)($k0)
    sdc1    $f22, THREAD_FPREGS(22)($k0)
    sdc1    $f23, THREAD_FPREGS(23)($k0)
    sdc1    $f24, THREAD_FPREGS(24)($k0)
    sdc1    $f25, THREAD_FPREGS(25)($k0)
    sdc1    $f26, THREAD_FPREGS(26)($k0)
    sdc1    $f27, THREAD_FPREGS(27)($k0)
    sdc1    $f28, THREAD_FPREGS(28)($k0)
    sdc1    $f29, THREAD_FPREGS(29)($k0)
    sdc1    $f30, THREAD_FPREGS(30)($k0)
    sdc1    $f31, THREAD_FPREGS(31)($k0)
...
LEAF(__osEnqueueAndYield)
    ...
    beqz    $k1, 1f
     sw     $ra, THREAD_PC($a1)
    cfc1    $k1, C1_FPCSR
    sdc1    $f20, THREAD_FPREGS(20)($a1)
    sdc1    $f21, THREAD_FPREGS(21)($a1)
    sdc1    $f22, THREAD_FPREGS(22)($a1)
    sdc1    $f23, THREAD_FPREGS(23)($a1)
    sdc1    $f24, THREAD_FPREGS(24)($a1)
    sdc1    $f25, THREAD_FPREGS(25)($a1)
    sdc1    $f26, THREAD_FPREGS(26)($a1)
    sdc1    $f27, THREAD_FPREGS(27)($a1)
    sdc1    $f28, THREAD_FPREGS(28)($a1)
    sdc1    $f29, THREAD_FPREGS(29)($a1)
    sdc1    $f30, THREAD_FPREGS(30)($a1)
    sdc1    $f31, THREAD_FPREGS(31)($a1)
...
LEAF(__osDispatchThread)
    ...
    ctc1    $k1, C1_FPCSR
    ldc1    $f0, THREAD_FPREGS(0)($k0)
    ldc1    $f1, THREAD_FPREGS(1)($k0)
    ldc1    $f2, THREAD_FPREGS(2)($k0)
    ldc1    $f3, THREAD_FPREGS(3)($k0)
    ldc1    $f4, THREAD_FPREGS(4)($k0)
    ldc1    $f5, THREAD_FPREGS(5)($k0)
    ldc1    $f6, THREAD_FPREGS(6)($k0)
    ldc1    $f7, THREAD_FPREGS(7)($k0)
    ldc1    $f8, THREAD_FPREGS(8)($k0)
    ldc1    $f9, THREAD_FPREGS(9)($k0)
    ldc1    $f10, THREAD_FPREGS(10)($k0)
    ldc1    $f11, THREAD_FPREGS(11)($k0)
    ldc1    $f12, THREAD_FPREGS(12)($k0)
    ldc1    $f13, THREAD_FPREGS(13)($k0)
    ldc1    $f14, THREAD_FPREGS(14)($k0)
    ldc1    $f15, THREAD_FPREGS(15)($k0)
    ldc1    $f16, THREAD_FPREGS(16)($k0)
    ldc1    $f17, THREAD_FPREGS(17)($k0)
    ldc1    $f18, THREAD_FPREGS(18)($k0)
    ldc1    $f19, THREAD_FPREGS(19)($k0)
    ldc1    $f20, THREAD_FPREGS(20)($k0)
    ldc1    $f21, THREAD_FPREGS(21)($k0)
    ldc1    $f22, THREAD_FPREGS(22)($k0)
    ldc1    $f23, THREAD_FPREGS(23)($k0)
    ldc1    $f24, THREAD_FPREGS(24)($k0)
    ldc1    $f25, THREAD_FPREGS(25)($k0)
    ldc1    $f26, THREAD_FPREGS(26)($k0)
    ldc1    $f27, THREAD_FPREGS(27)($k0)
    ldc1    $f28, THREAD_FPREGS(28)($k0)
    ldc1    $f29, THREAD_FPREGS(29)($k0)
    ldc1    $f30, THREAD_FPREGS(30)($k0)
    ldc1    $f31, THREAD_FPREGS(31)($k0)
1:
