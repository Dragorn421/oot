...
void Interface_ChangeAlpha(u16 alphaType) {
    if (alphaType != GET_UNK_13_E_A) {
        osSyncPrintf("ＡＬＰＨＡーＴＹＰＥ＝%d  LAST_TIME_TYPE=%d\n", alphaType, GET_UNK_13_E_E);
        SET_UNK_13_E_A(gSaveContext.unk_13E8 = alphaType)
        SET_UNK_13_E_C(1)
    }
}
...
void func_80082644(PlayState* play, s16 alpha) {
    ...
    if (GET_BUTTON_STATUS[0] == BTN_DISABLED) {
    ...
    if (GET_BUTTON_STATUS[1] == BTN_DISABLED) {
    ...
    if (GET_BUTTON_STATUS[2] == BTN_DISABLED) {
    ...
    if (GET_BUTTON_STATUS[3] == BTN_DISABLED) {
    ...
    if (GET_BUTTON_STATUS[4] == BTN_DISABLED) {
...
void func_80083108(PlayState* play) {
    ...
    if ((GET_CUTSCENE_INDEX < 0xFFF0) ||
        ((play->sceneId == SCENE_SPOT20) && (GET_CUTSCENE_INDEX == 0xFFF0))) {
        SET_UNK_13_E7(0)

        if ((player->stateFlags1 & PLAYER_STATE1_23) || (play->shootingGalleryStatus > 1) ||
            ((play->sceneId == SCENE_BOWLING) && Flags_GetSwitch(play, 0x38))) {
            if (GET_EQUIPS_BUTTON_ITEMS[0] != ITEM_NONE) {
                SET_UNK_13_E7(1)

                if (GET_BUTTON_STATUS[0] == BTN_DISABLED) {
                    GET_BUTTON_STATUS[0] = GET_BUTTON_STATUS[1] = GET_BUTTON_STATUS[2] =
                        GET_BUTTON_STATUS[3] = BTN_ENABLED;
                }

                if ((GET_EQUIPS_BUTTON_ITEMS[0] != ITEM_SLINGSHOT) &&
                    (GET_EQUIPS_BUTTON_ITEMS[0] != ITEM_BOW) &&
                    (GET_EQUIPS_BUTTON_ITEMS[0] != ITEM_BOMBCHU) &&
                    (GET_EQUIPS_BUTTON_ITEMS[0] != ITEM_NONE)) {
                    GET_BUTTON_STATUS[0] = GET_EQUIPS_BUTTON_ITEMS[0];
                    ...
                    if ((play->sceneId == SCENE_BOWLING) && Flags_GetSwitch(play, 0x38)) {
                        ...
                        if (play->shootingGalleryStatus > 1) {
                            if (LINK_AGE_IN_YEARS == YEARS_CHILD) {
                                GET_EQUIPS_BUTTON_ITEMS[0] = ITEM_SLINGSHOT;
                            }

                            Interface_LoadItemIcon1(play, 0);
                        } else {
                            if (GET_INVENTORY_ITEMS[SLOT_BOW] == ITEM_NONE) {
                                GET_EQUIPS_BUTTON_ITEMS[0] = ITEM_NONE;
                            } else {
                                Interface_LoadItemIcon1(play, 0);
                            }
                    ...
                    GET_BUTTON_STATUS[1] = GET_BUTTON_STATUS[2] = GET_BUTTON_STATUS[3] =
                        BTN_DISABLED;
            ...
            if (play->interfaceCtx.unk_260 != 0) {
                if (GET_EQUIPS_BUTTON_ITEMS[0] != ITEM_FISHING_POLE) {
                    GET_BUTTON_STATUS[0] = GET_EQUIPS_BUTTON_ITEMS[0];
                    GET_EQUIPS_BUTTON_ITEMS[0] = ITEM_FISHING_POLE;
                    SET_UNK_13_E_A(0)
                    Interface_LoadItemIcon1(play, 0);
                    Interface_ChangeAlpha(12);
                }

                if (GET_UNK_13_E_A != 12) {
                    Interface_ChangeAlpha(12);
                }
            } else if (GET_EQUIPS_BUTTON_ITEMS[0] == ITEM_FISHING_POLE) {
                GET_EQUIPS_BUTTON_ITEMS[0] = GET_BUTTON_STATUS[0];
                SET_UNK_13_E_A(0)
                ...
                GET_BUTTON_STATUS[0] = GET_BUTTON_STATUS[1] = GET_BUTTON_STATUS[2] =
                    GET_BUTTON_STATUS[3] = BTN_DISABLED;
                Interface_ChangeAlpha(50);
            } else {
                if (GET_BUTTON_STATUS[0] == BTN_ENABLED) {
                    SET_UNK_13_E_A(0)
                }
            ...
            if ((func_8008F2F8(play) >= 2) && (func_8008F2F8(play) < 5)) {
                ...
                GET_BUTTON_STATUS[0] = BTN_DISABLED;

                for (i = 1; i < 4; i++) {
                    if (func_8008F2F8(play) == 2) {
                        if ((GET_EQUIPS_BUTTON_ITEMS[i] != ITEM_HOOKSHOT) &&
                            (GET_EQUIPS_BUTTON_ITEMS[i] != ITEM_LONGSHOT)) {
                            if (GET_BUTTON_STATUS[i] == BTN_ENABLED) {
                                sp28 = true;
                            }

                            GET_BUTTON_STATUS[i] = BTN_DISABLED;
                        } else {
                            if (GET_BUTTON_STATUS[i] == BTN_DISABLED) {
                                sp28 = true;
                            }

                            GET_BUTTON_STATUS[i] = BTN_ENABLED;
                        }
                    } else {
                        if (GET_BUTTON_STATUS[i] == BTN_ENABLED) {
                            sp28 = true;
                ...
                if (GET_BUTTON_STATUS[0] != BTN_DISABLED) {
                    GET_BUTTON_STATUS[0] = BTN_DISABLED;
                    GET_BUTTON_STATUS[1] = BTN_DISABLED;
                    GET_BUTTON_STATUS[2] = BTN_DISABLED;
                    GET_BUTTON_STATUS[3] = BTN_DISABLED;
                    SET_UNK_13_E_A(0)
                    Interface_ChangeAlpha(50);
                }
                ...
                for (i = 1; i < 4; i++) {
                    if ((GET_EQUIPS_BUTTON_ITEMS[i] != ITEM_OCARINA_FAIRY) &&
                        (GET_EQUIPS_BUTTON_ITEMS[i] != ITEM_OCARINA_TIME)) {
                        if (GET_BUTTON_STATUS[i] == BTN_ENABLED) {
                            sp28 = true;
                        }
                ...
                if (interfaceCtx->restrictions.bButton == 0) {
                    if ((GET_EQUIPS_BUTTON_ITEMS[0] == ITEM_SLINGSHOT) ||
                        ...
                        (GET_EQUIPS_BUTTON_ITEMS[0] == ITEM_NONE)) {
                        if ((GET_EQUIPS_BUTTON_ITEMS[0] != ITEM_NONE) ||
                            (GET_INF_TABLE[INFTABLE_1DX_INDEX] == 0)) {
                            GET_EQUIPS_BUTTON_ITEMS[0] = GET_BUTTON_STATUS[0];
                            sp28 = true;
                    ...
                    } else if ((GET_BUTTON_STATUS[0] & 0xFF) == BTN_DISABLED) {
                        sp28 = true;

                        if (((GET_BUTTON_STATUS[0] & 0xFF) == BTN_DISABLED) ||
                            ((GET_BUTTON_STATUS[0] & 0xFF) == BTN_ENABLED)) {
                            GET_BUTTON_STATUS[0] = BTN_ENABLED;
                        } else {
                            GET_EQUIPS_BUTTON_ITEMS[0] = GET_BUTTON_STATUS[0] & 0xFF;
                        }
                    }
                ...
                if (interfaceCtx->restrictions.bottles != 0) {
                    for (i = 1; i < 4; i++) {
                        if ((GET_EQUIPS_BUTTON_ITEMS[i] >= ITEM_BOTTLE) &&
                            (GET_EQUIPS_BUTTON_ITEMS[i] <= ITEM_POE)) {
                            if (GET_BUTTON_STATUS[i] == BTN_ENABLED) {
                                sp28 = true;
                            }
                ...
                if (interfaceCtx->restrictions.tradeItems != 0) {
                    for (i = 1; i < 4; i++) {
                        if ((GET_EQUIPS_BUTTON_ITEMS[i] >= ITEM_WEIRD_EGG) &&
                            (GET_EQUIPS_BUTTON_ITEMS[i] <= ITEM_CLAIM_CHECK)) {
                            if (GET_BUTTON_STATUS[i] == BTN_ENABLED) {
                                sp28 = true;
                            }
                ...
                if (interfaceCtx->restrictions.farores != 0) {
                    for (i = 1; i < 4; i++) {
                        if (GET_EQUIPS_BUTTON_ITEMS[i] == ITEM_FARORES_WIND) {
                            if (GET_BUTTON_STATUS[i] == BTN_ENABLED) {
                                sp28 = true;
                            }
                ...
                if (interfaceCtx->restrictions.dinsNayrus != 0) {
                    for (i = 1; i < 4; i++) {
                        if ((GET_EQUIPS_BUTTON_ITEMS[i] == ITEM_DINS_FIRE) ||
                            (GET_EQUIPS_BUTTON_ITEMS[i] == ITEM_NAYRUS_LOVE)) {
                            if (GET_BUTTON_STATUS[i] == BTN_ENABLED) {
                                sp28 = true;
                            }
                ...
                if (interfaceCtx->restrictions.all != 0) {
                    for (i = 1; i < 4; i++) {
                        if ((GET_EQUIPS_BUTTON_ITEMS[i] != ITEM_OCARINA_FAIRY) &&
                            (GET_EQUIPS_BUTTON_ITEMS[i] != ITEM_OCARINA_TIME) &&
                            !((GET_EQUIPS_BUTTON_ITEMS[i] >= ITEM_BOTTLE) &&
                              (GET_EQUIPS_BUTTON_ITEMS[i] <= ITEM_POE)) &&
                            !((GET_EQUIPS_BUTTON_ITEMS[i] >= ITEM_WEIRD_EGG) &&
                              (GET_EQUIPS_BUTTON_ITEMS[i] <= ITEM_CLAIM_CHECK))) {
                            if ((play->sceneId != SCENE_TAKARAYA) ||
                                (GET_EQUIPS_BUTTON_ITEMS[i] != ITEM_LENS)) {
                                if (GET_BUTTON_STATUS[i] == BTN_ENABLED) {
                                    sp28 = true;
                                }
                    ...
                    for (i = 1; i < 4; i++) {
                        if ((GET_EQUIPS_BUTTON_ITEMS[i] != ITEM_DINS_FIRE) &&
                            (GET_EQUIPS_BUTTON_ITEMS[i] != ITEM_HOOKSHOT) &&
                            (GET_EQUIPS_BUTTON_ITEMS[i] != ITEM_LONGSHOT) &&
                            (GET_EQUIPS_BUTTON_ITEMS[i] != ITEM_FARORES_WIND) &&
                            (GET_EQUIPS_BUTTON_ITEMS[i] != ITEM_NAYRUS_LOVE) &&
                            (GET_EQUIPS_BUTTON_ITEMS[i] != ITEM_OCARINA_FAIRY) &&
                            (GET_EQUIPS_BUTTON_ITEMS[i] != ITEM_OCARINA_TIME) &&
                            !((GET_EQUIPS_BUTTON_ITEMS[i] >= ITEM_BOTTLE) &&
                              (GET_EQUIPS_BUTTON_ITEMS[i] <= ITEM_POE)) &&
                            !((GET_EQUIPS_BUTTON_ITEMS[i] >= ITEM_WEIRD_EGG) &&
...
void Inventory_SwapAgeEquipment(void) {
    ...
    if (LINK_AGE_IN_YEARS == YEARS_CHILD) {
        for (i = 0; i < 4; i++) {
            if (i != 0) {
                GET_CHILD_EQUIPS_BUTTON_ITEMS[i] =
                    GET_EQUIPS_BUTTON_ITEMS[i];
            } else {
                GET_CHILD_EQUIPS_BUTTON_ITEMS[i] = ITEM_SWORD_KOKIRI;
            }

            if (i != 0) {
                GET_CHILD_EQUIPS_C_BUTTON_SLOTS[i - 1] =
                    GET_EQUIPS_C_BUTTON_SLOTS[i - 1];
            }
        }

        SET_CHILD_EQUIPS_EQUIPMENT(gSaveContext.save.info.equips.equipment)

        if (GET_ADULT_EQUIPS_BUTTON_ITEMS[0] == ITEM_NONE) {
            GET_EQUIPS_BUTTON_ITEMS[0] = ITEM_SWORD_MASTER;

            if (GET_INVENTORY_ITEMS[SLOT_NUT] != ITEM_NONE) {
                GET_EQUIPS_BUTTON_ITEMS[1] = ITEM_NUT;
                GET_EQUIPS_C_BUTTON_SLOTS[0] = SLOT_NUT;
            } else {
                GET_EQUIPS_BUTTON_ITEMS[1] = GET_EQUIPS_C_BUTTON_SLOTS[0] =
                    ITEM_NONE;
            }

            GET_EQUIPS_BUTTON_ITEMS[2] = ITEM_BOMB;
            GET_EQUIPS_BUTTON_ITEMS[3] = GET_INVENTORY_ITEMS[SLOT_OCARINA];
            GET_EQUIPS_C_BUTTON_SLOTS[1] = SLOT_BOMB;
            GET_EQUIPS_C_BUTTON_SLOTS[2] = SLOT_OCARINA;
            ...
            for (i = 0; i < 4; i++) {
                GET_EQUIPS_BUTTON_ITEMS[i] =
                    GET_ADULT_EQUIPS_BUTTON_ITEMS[i];

                if (i != 0) {
                    GET_EQUIPS_C_BUTTON_SLOTS[i - 1] =
                        GET_ADULT_EQUIPS_C_BUTTON_SLOTS[i - 1];
                }
                ...
                if (((GET_EQUIPS_BUTTON_ITEMS[i] >= ITEM_BOTTLE) &&
                    ...
                    ((GET_EQUIPS_BUTTON_ITEMS[i] >= ITEM_WEIRD_EGG) &&
                     (GET_EQUIPS_BUTTON_ITEMS[i] <= ITEM_CLAIM_CHECK))) {
                    osSyncPrintf("Register_Item_Pt(%d)=%d\n", i, GET_EQUIPS_C_BUTTON_SLOTS[i - 1]);
                    GET_EQUIPS_BUTTON_ITEMS[i] =
                        GET_INVENTORY_ITEMS[GET_EQUIPS_C_BUTTON_SLOTS[i - 1]];
                }
            }

            SET_EQUIPS_EQUIPMENT(gSaveContext.save.info.playerData.adultEquips.equipment)
        }
    } else {
        for (i = 0; i < 4; i++) {
            GET_ADULT_EQUIPS_BUTTON_ITEMS[i] = GET_EQUIPS_BUTTON_ITEMS[i];
        ...
        SET_ADULT_EQUIPS_EQUIPMENT(gSaveContext.save.info.equips.equipment)

        if (GET_CHILD_EQUIPS_BUTTON_ITEMS[0] != ITEM_NONE) {
            for (i = 0; i < 4; i++) {
                GET_EQUIPS_BUTTON_ITEMS[i] =
                    GET_CHILD_EQUIPS_BUTTON_ITEMS[i];
            ...
            SET_EQUIPS_EQUIPMENT(gSaveContext.save.info.playerData.childEquips.equipment)
            GET_EQUIPS_EQUIPMENT &= (u16) ~(0xF << (EQUIP_TYPE_SWORD * 4));
            GET_EQUIPS_EQUIPMENT |= EQUIP_VALUE_SWORD_KOKIRI << (EQUIP_TYPE_SWORD * 4);
        }
    }
    ...
    if (shieldEquipValue != 0) {
        ...
        if (!CHECK_OWNED_EQUIP_ALT(EQUIP_TYPE_SHIELD, shieldEquipValue - 1)) {
            GET_EQUIPS_EQUIPMENT &= gEquipNegMasks[EQUIP_TYPE_SHIELD];
        }
    }
}
...
void Interface_InitHorsebackArchery(PlayState* play) {
    ...
    SET_MINIGAME_STATE(1)
    interfaceCtx->unk_23C = interfaceCtx->unk_240 = interfaceCtx->unk_242 = 0;
    SET_MINIGAME_SCORE(sHBAScoreTier = 0)
    interfaceCtx->hbaAmmo = 20;
}

void func_800849EC(PlayState* play) {
    GET_INVENTORY_EQUIPMENT |= OWNED_EQUIP_FLAG(EQUIP_TYPE_SWORD, EQUIP_INV_SWORD_BGS);
...
void Interface_LoadItemIcon1(PlayState* play, u16 button) {
    ...
    DmaMgr_SendRequest2(&interfaceCtx->dmaRequest_160, interfaceCtx->iconItemSegment + button * 0x1000,
                        (uintptr_t)_icon_item_staticSegmentRomStart +
                            (GET_EQUIPS_BUTTON_ITEMS[button] * 0x1000),
...
void func_80084BF4(PlayState* play, u16 flag) {
    if (flag) {
        ...
        } else if (GET_EQUIPS_BUTTON_ITEMS[0] == ITEM_NONE) {
            if ((GET_EQUIPS_BUTTON_ITEMS[0] != ITEM_NONE) ||
                (GET_INF_TABLE[INFTABLE_1DX_INDEX] == 0)) {
                GET_EQUIPS_BUTTON_ITEMS[0] = GET_BUTTON_STATUS[0];
                Interface_LoadItemIcon1(play, 0);
...
u8 Item_Give(PlayState* play, u8 item) {
    ...
    osSyncPrintf(VT_FGCOL(YELLOW));
    osSyncPrintf("item_get_setting=%d  pt=%d  z=%x\n", item, slot, GET_INVENTORY_ITEMS[slot]);
    osSyncPrintf(VT_RST);

    if ((item >= ITEM_MEDALLION_FOREST) && (item <= ITEM_MEDALLION_LIGHT)) {
        GET_INVENTORY_QUEST_ITEMS |= gBitFlags[item - ITEM_MEDALLION_FOREST + QUEST_MEDALLION_FOREST];

        osSyncPrintf(VT_FGCOL(YELLOW));
        osSyncPrintf("封印 = %x\n", GET_INVENTORY_QUEST_ITEMS); // "Seals = %x"
        osSyncPrintf(VT_RST);
        ...
        GET_INVENTORY_QUEST_ITEMS |= gBitFlags[item - ITEM_SONG_MINUET + QUEST_SONG_MINUET];

        osSyncPrintf(VT_FGCOL(YELLOW));
        osSyncPrintf("楽譜 = %x\n", GET_INVENTORY_QUEST_ITEMS); // "Musical scores = %x"
        // "Musical scores = %x (%x) (%x)"
        osSyncPrintf("楽譜 = %x (%x) (%x)\n", GET_INVENTORY_QUEST_ITEMS,
        ...
        GET_INVENTORY_QUEST_ITEMS |= gBitFlags[item - ITEM_KOKIRI_EMERALD + QUEST_KOKIRI_EMERALD];

        osSyncPrintf(VT_FGCOL(YELLOW));
        osSyncPrintf("精霊石 = %x\n", GET_INVENTORY_QUEST_ITEMS); // "Spiritual Stones = %x"
        osSyncPrintf(VT_RST);

        return ITEM_NONE;
    } else if ((item == ITEM_STONE_OF_AGONY) || (item == ITEM_GERUDO_CARD)) {
        GET_INVENTORY_QUEST_ITEMS |= gBitFlags[item - ITEM_STONE_OF_AGONY + QUEST_STONE_OF_AGONY];

        osSyncPrintf(VT_FGCOL(YELLOW));
        osSyncPrintf("アイテム = %x\n", GET_INVENTORY_QUEST_ITEMS); // "Items = %x"
        osSyncPrintf(VT_RST);

        return ITEM_NONE;
    } else if (item == ITEM_SKULL_TOKEN) {
        GET_INVENTORY_QUEST_ITEMS |= gBitFlags[item - ITEM_SKULL_TOKEN + QUEST_SKULL_TOKEN];
        GET_INVENTORY_GS_TOKENS++;
        ...
        if (item == ITEM_SWORD_BGS) {
            ...
            if (ALL_EQUIP_VALUE(EQUIP_TYPE_SWORD) ==
                ...
                GET_INVENTORY_EQUIPMENT ^=
                    OWNED_EQUIP_FLAG_ALT(EQUIP_TYPE_SWORD, EQUIP_INV_SWORD_BROKENGIANTKNIFE);
                if (GET_EQUIPS_BUTTON_ITEMS[0] == ITEM_SWORD_KNIFE) {
                    GET_EQUIPS_BUTTON_ITEMS[0] = ITEM_SWORD_BGS;
                    Interface_LoadItemIcon1(play, 0);
                }
            }
        ...
        GET_INVENTORY_EQUIPMENT |= OWNED_EQUIP_FLAG(EQUIP_TYPE_SHIELD, item - ITEM_SHIELD_DEKU);
        return ITEM_NONE;
    } else if ((item >= ITEM_TUNIC_KOKIRI) && (item <= ITEM_TUNIC_ZORA)) {
        GET_INVENTORY_EQUIPMENT |= OWNED_EQUIP_FLAG(EQUIP_TYPE_TUNIC, item - ITEM_TUNIC_KOKIRI);
        return ITEM_NONE;
    } else if ((item >= ITEM_BOOTS_KOKIRI) && (item <= ITEM_BOOTS_HOVER)) {
        GET_INVENTORY_EQUIPMENT |= OWNED_EQUIP_FLAG(EQUIP_TYPE_BOOTS, item - ITEM_BOOTS_KOKIRI);
        return ITEM_NONE;
    } else if ((item == ITEM_KEY_BOSS) || (item == ITEM_COMPASS) || (item == ITEM_DUNGEON_MAP)) {
        GET_INVENTORY_DUNGEON_ITEMS[GET_MAP_INDEX] |= gBitFlags[item - ITEM_KEY_BOSS];
        return ITEM_NONE;
    } else if (item == ITEM_KEY_SMALL) {
        if (GET_INVENTORY_DUNGEON_KEYS[GET_MAP_INDEX] < 0) {
            GET_INVENTORY_DUNGEON_KEYS[GET_MAP_INDEX] = 1;
            return ITEM_NONE;
        } else {
            GET_INVENTORY_DUNGEON_KEYS[GET_MAP_INDEX]++;
            return ITEM_NONE;
        }
        ...
        if (GET_INVENTORY_ITEMS[slot] == ITEM_NONE) {
        ...
        GET_INVENTORY_QUEST_ITEMS += 1 << QUEST_HEART_PIECE_COUNT;
        return ITEM_NONE;
    } else if (item == ITEM_HEART_CONTAINER) {
        GET_HEALTH_CAPACITY += 0x10;
        GET_HEALTH += 0x10;
        return ITEM_NONE;
        ...
        if (GET_MAGIC_STATE != MAGIC_STATE_ADD) {
        ...
        for (i = 0; i < 4; i++) {
            if (GET_INVENTORY_ITEMS[temp + i] == ITEM_NONE) {
                GET_INVENTORY_ITEMS[temp + i] = item;
                return ITEM_NONE;
            }
        }
        ...
        if ((item != ITEM_MILK_BOTTLE) && (item != ITEM_LETTER_RUTO)) {
            ...
            for (i = 0; i < 4; i++) {
                if (GET_INVENTORY_ITEMS[temp + i] == ITEM_BOTTLE) {
                    // "Item_Pt(1)=%d Item_Pt(2)=%d Item_Pt(3)=%d   Empty Bottle=%d   Content=%d"
                    osSyncPrintf("Item_Pt(1)=%d Item_Pt(2)=%d Item_Pt(3)=%d   空瓶=%d   中味=%d\n",
                                 GET_EQUIPS_C_BUTTON_SLOTS[0],
                                 GET_EQUIPS_C_BUTTON_SLOTS[1],
                                 GET_EQUIPS_C_BUTTON_SLOTS[2], temp + i, item);

                    if ((temp + i) == GET_EQUIPS_C_BUTTON_SLOTS[0]) {
                        GET_EQUIPS_BUTTON_ITEMS[1] = item;
                        Interface_LoadItemIcon2(play, 1);
                        GET_BUTTON_STATUS[1] = BTN_ENABLED;
                    } else if ((temp + i) == GET_EQUIPS_C_BUTTON_SLOTS[1]) {
                        GET_EQUIPS_BUTTON_ITEMS[2] = item;
                        Interface_LoadItemIcon2(play, 2);
                        GET_BUTTON_STATUS[2] = BTN_ENABLED;
                    } else if ((temp + i) == GET_EQUIPS_C_BUTTON_SLOTS[2]) {
                        GET_EQUIPS_BUTTON_ITEMS[3] = item;
        ...
        if (temp != ITEM_NONE) {
            for (i = 1; i < 4; i++) {
                if (temp == GET_EQUIPS_BUTTON_ITEMS[i]) {
                    if (item != ITEM_SOLD_OUT) {
                        GET_EQUIPS_BUTTON_ITEMS[i] = item;
                        Interface_LoadItemIcon1(play, i);
                    } else {
                        GET_EQUIPS_BUTTON_ITEMS[i] = ITEM_NONE;
                    }
                    return ITEM_NONE;
                }
            }
...
u8 Item_CheckObtainability(u8 item) {
    ...
    return GET_INVENTORY_ITEMS[slot];
}
...
void Inventory_DeleteItem(u16 item, u16 invSlot) {
    ...
    GET_INVENTORY_ITEMS[invSlot] = ITEM_NONE;

    osSyncPrintf("\nItem_Register(%d)\n", invSlot, GET_INVENTORY_ITEMS[invSlot]);

    for (i = 1; i < 4; i++) {
        if (GET_EQUIPS_BUTTON_ITEMS[i] == item) {
            GET_EQUIPS_BUTTON_ITEMS[i] = ITEM_NONE;
            GET_EQUIPS_C_BUTTON_SLOTS[i - 1] = SLOT_NONE;
        }
    }
}
...
s32 Inventory_ReplaceItem(PlayState* play, u16 oldItem, u16 newItem) {
    ...
    for (i = 0; i < ARRAY_COUNT(GET_INVENTORY_ITEMS); i++) {
        if (GET_INVENTORY_ITEMS[i] == oldItem) {
            GET_INVENTORY_ITEMS[i] = newItem;
            osSyncPrintf("アイテム消去(%d)\n", i); // "Item Purge (%d)"
            for (i = 1; i < 4; i++) {
                if (GET_EQUIPS_BUTTON_ITEMS[i] == oldItem) {
                    GET_EQUIPS_BUTTON_ITEMS[i] = newItem;
                    Interface_LoadItemIcon1(play, i);
                    break;
                }
            }
...
void Inventory_UpdateBottleItem(PlayState* play, u8 item, u8 button) {
    osSyncPrintf("item_no=%x,  c_no=%x,  Pt=%x  Item_Register=%x\n", item, button,
                 GET_EQUIPS_C_BUTTON_SLOTS[button - 1],
                 GET_INVENTORY_ITEMS[GET_EQUIPS_C_BUTTON_SLOTS[button - 1]]);

    // Special case to only empty half of a Lon Lon Milk Bottle
    if ((GET_INVENTORY_ITEMS[GET_EQUIPS_C_BUTTON_SLOTS[button - 1]] ==
         ITEM_MILK_BOTTLE) &&
        (item == ITEM_BOTTLE)) {
        item = ITEM_MILK_HALF;
    }

    GET_INVENTORY_ITEMS[GET_EQUIPS_C_BUTTON_SLOTS[button - 1]] = item;
    GET_EQUIPS_BUTTON_ITEMS[button] = item;

    Interface_LoadItemIcon1(play, button);

    play->pauseCtx.cursorItem[PAUSE_ITEM] = item;
    GET_BUTTON_STATUS[button] = BTN_ENABLED;
}
...
s32 Inventory_ConsumeFairy(PlayState* play) {
    ...
    for (i = 0; i < 4; i++) {
        if (GET_INVENTORY_ITEMS[bottleSlot + i] == ITEM_FAIRY) {
            for (j = 1; j < 4; j++) {
                if (GET_EQUIPS_BUTTON_ITEMS[j] == ITEM_FAIRY) {
                    GET_EQUIPS_BUTTON_ITEMS[j] = ITEM_BOTTLE;
                    Interface_LoadItemIcon1(play, j);
                    i = 0;
                    bottleSlot = GET_EQUIPS_C_BUTTON_SLOTS[j - 1];
                    break;
                }
            }
            osSyncPrintf("妖精使用＝%d\n", bottleSlot); // "Fairy Usage＝%d"
            GET_INVENTORY_ITEMS[bottleSlot + i] = ITEM_BOTTLE;
            return true;
        }
    }
...
s32 Health_ChangeBy(PlayState* play, s16 amount) {
    ...
    } else if (GET_IS_DOUBLE_DEFENSE_ACQUIRED && (amount < 0)) {
        amount >>= 1;
    ...
    if (GET_HEALTH > GET_HEALTH_CAPACITY) {
        SET_HEALTH(gSaveContext.save.info.playerData.healthCapacity)
    }
...
void Health_GiveHearts(s16 hearts) {
    GET_HEALTH_CAPACITY += hearts * 0x10;
}

void Rupees_ChangeBy(s16 rupeeChange) {
    GET_RUPEE_ACCUMULATOR += rupeeChange;
}
...
void Magic_Fill(PlayState* play) {
    if (GET_IS_MAGIC_ACQUIRED) {
        SET_PREV_MAGIC_STATE(gSaveContext.magicState)
        SET_MAGIC_FILL_TARGET((gSaveContext.save.info.playerData.isDoubleMagicAcquired + 1) * MAGIC_NORMAL_METER)
        SET_MAGIC_STATE(MAGIC_STATE_FILL)
    }
}

void Magic_Reset(PlayState* play) {
    if ((GET_MAGIC_STATE != MAGIC_STATE_STEP_CAPACITY) && (GET_MAGIC_STATE != MAGIC_STATE_FILL)) {
        if (GET_MAGIC_STATE == MAGIC_STATE_ADD) {
            SET_PREV_MAGIC_STATE(gSaveContext.magicState)
        }
        SET_MAGIC_STATE(MAGIC_STATE_RESET)
    }
}
    ...
    switch (type) {
        ...
        case MAGIC_CONSUME_NOW_ALT:
            ...
            if ((GET_MAGIC_STATE == MAGIC_STATE_IDLE) ||
                (GET_MAGIC_STATE == MAGIC_STATE_CONSUME_LENS)) {
                if (GET_MAGIC_STATE == MAGIC_STATE_CONSUME_LENS) {
                    play->actorCtx.lensActive = false;
                }
                SET_MAGIC_TARGET(gSaveContext.save.info.playerData.magic - amount)
        ...
        case MAGIC_CONSUME_WAIT_NO_PREVIEW:
            ...
            if ((GET_MAGIC_STATE == MAGIC_STATE_IDLE) ||
                ...
                SET_MAGIC_TARGET(gSaveContext.save.info.playerData.magic - amount)
                SET_MAGIC_STATE(MAGIC_STATE_METER_FLASH_3)
                return true;
            } else {
                Audio_PlaySfxGeneral(NA_SE_SY_ERROR, &gSfxDefaultPos, 4, &gSfxDefaultFreqAndVolScale,
                                     &gSfxDefaultFreqAndVolScale, &gSfxDefaultReverb);
        ...
        case MAGIC_CONSUME_LENS:
            if (GET_MAGIC_STATE == MAGIC_STATE_IDLE) {
                if (GET_MAGIC != 0) {
                    ...
                    SET_MAGIC_STATE(MAGIC_STATE_CONSUME_LENS)
                    return true;
                } else {
                    return false;
                }
            } else if (GET_MAGIC_STATE == MAGIC_STATE_CONSUME_LENS) {
                return true;
            } else {
                return false;
            }
        ...
        case MAGIC_CONSUME_WAIT_PREVIEW:
            ...
            if ((GET_MAGIC_STATE == MAGIC_STATE_IDLE) ||
                ...
                SET_MAGIC_TARGET(gSaveContext.save.info.playerData.magic - amount)
                SET_MAGIC_STATE(MAGIC_STATE_METER_FLASH_2)
                return true;
            } else {
                Audio_PlaySfxGeneral(NA_SE_SY_ERROR, &gSfxDefaultPos, 4, &gSfxDefaultFreqAndVolScale,
                                     &gSfxDefaultFreqAndVolScale, &gSfxDefaultReverb);
        ...
        case MAGIC_ADD:
            ...
            if (GET_MAGIC <= GET_MAGIC_CAPACITY) {
                SET_MAGIC_TARGET(gSaveContext.save.info.playerData.magic + amount)

                if (GET_MAGIC_TARGET >= GET_MAGIC_CAPACITY) {
                    SET_MAGIC_TARGET(gSaveContext.magicCapacity)
                }

                SET_MAGIC_STATE(MAGIC_STATE_ADD)
                return true;
            }
            break;
    }
...
void Magic_Update(PlayState* play) {
    ...
    switch (GET_MAGIC_STATE) {
        case MAGIC_STATE_STEP_CAPACITY:
            // Step magicCapacity to the capacity determined by magicLevel
            // This changes the width of the magic meter drawn
            temp = GET_MAGIC_LEVEL * MAGIC_NORMAL_METER;
            if (GET_MAGIC_CAPACITY != temp) {
                if (GET_MAGIC_CAPACITY < temp) {
                    GET_MAGIC_CAPACITY += 8;
                    if (GET_MAGIC_CAPACITY > temp) {
                        SET_MAGIC_CAPACITY(temp)
                    }
                } else {
                    GET_MAGIC_CAPACITY -= 8;
                    if (GET_MAGIC_CAPACITY <= temp) {
        ...
        case MAGIC_STATE_FILL:
            ...
            if (GET_GAME_MODE == GAMEMODE_NORMAL && !IS_CUTSCENE_LAYER) {
            ...
            osSyncPrintf("蓄電  MAGIC_NOW=%d (%d)\n", GET_MAGIC,
                         GET_MAGIC_FILL_TARGET);

            if (GET_MAGIC >= GET_MAGIC_FILL_TARGET) {
                SET_MAGIC(gSaveContext.magicFillTarget)
                SET_MAGIC_STATE(gSaveContext.prevMagicState)
        ...
        case MAGIC_STATE_CONSUME_SETUP:
            ...
            sMagicBorderRatio = 2;
            SET_MAGIC_STATE(MAGIC_STATE_CONSUME)
            break;
        ...
        case MAGIC_STATE_CONSUME:
            ...
            if (GET_MAGIC <= 0) {
                SET_MAGIC(0)
                SET_MAGIC_STATE(MAGIC_STATE_METER_FLASH_1)
                sMagicBorderR = sMagicBorderG = sMagicBorderB = 255;
            } else if (GET_MAGIC == GET_MAGIC_TARGET) {
                SET_MAGIC_STATE(MAGIC_STATE_METER_FLASH_1)
                sMagicBorderR = sMagicBorderG = sMagicBorderB = 255;
            }
        ...
        case MAGIC_STATE_CONSUME_LENS:
            ...
            if ((play->pauseCtx.state == 0) && (play->pauseCtx.debugState == 0) && (msgCtx->msgMode == MSGMODE_NONE) &&
                ...
                if ((GET_MAGIC == 0) ||
                    ...
                    ((GET_EQUIPS_BUTTON_ITEMS[1] != ITEM_LENS) &&
                     (GET_EQUIPS_BUTTON_ITEMS[2] != ITEM_LENS) &&
                     (GET_EQUIPS_BUTTON_ITEMS[3] != ITEM_LENS)) ||
        ...
        case MAGIC_STATE_ADD:
            ...
            Audio_PlaySfxGeneral(NA_SE_SY_GAUGE_UP - SFX_FLAG, &gSfxDefaultPos, 4, &gSfxDefaultFreqAndVolScale,
                                 &gSfxDefaultFreqAndVolScale, &gSfxDefaultReverb);
            if (GET_MAGIC >= GET_MAGIC_TARGET) {
                SET_MAGIC(gSaveContext.magicTarget)
                SET_MAGIC_STATE(gSaveContext.prevMagicState)
                SET_PREV_MAGIC_STATE(MAGIC_STATE_IDLE)
            }
            break;
...
void Magic_DrawMeter(PlayState* play) {
    ...
    if (GET_MAGIC_LEVEL != 0) {
        ...
        OVERLAY_DISP = Gfx_TextureIA8(OVERLAY_DISP, gMagicMeterMidTex, 24, 16, R_MAGIC_METER_X + 8, magicMeterY,
                                      GET_MAGIC_CAPACITY, 16, 1 << 10, 1 << 10);

        gDPLoadTextureBlock(OVERLAY_DISP++, gMagicMeterEndTex, G_IM_FMT_IA, G_IM_SIZ_8b, 8, 16, 0,
                            G_TX_MIRROR | G_TX_WRAP, G_TX_NOMIRROR | G_TX_WRAP, 3, G_TX_NOMASK, G_TX_NOLOD, G_TX_NOLOD);

        gSPTextureRectangle(OVERLAY_DISP++, (R_MAGIC_METER_X + GET_MAGIC_CAPACITY + 8) << 2, magicMeterY << 2,
                            (R_MAGIC_METER_X + GET_MAGIC_CAPACITY + 16) << 2, (magicMeterY + 16) << 2,
        ...
        if (GET_MAGIC_STATE == MAGIC_STATE_METER_FLASH_2) {
            ...
            gSPTextureRectangle(OVERLAY_DISP++, R_MAGIC_FILL_X << 2, (magicMeterY + 3) << 2,
                                (R_MAGIC_FILL_X + GET_MAGIC_TARGET) << 2, (magicMeterY + 10) << 2,
...
void func_80088AF0(PlayState* play) {
    if (GET_TIMER2_STATE != 0) {
        if (GET_EVENTINF(EVENTINF_10)) {
            SET_TIMER2_VALUE(239)
        } else {
            SET_TIMER2_VALUE(1)
        }
    }
...
void Interface_DrawItemButtons(PlayState* play) {
    ...
    if (interfaceCtx->naviCalling && (play->pauseCtx.state == 0) && (play->pauseCtx.debugState == 0) &&
        ...
        if (!sCUpInvisible) {
            ...
            if ((GET_UNK_13_E_A == 1) || (GET_UNK_13_E_A == 2) || (GET_UNK_13_E_A == 5)) {
                temp = 0;
    ...
    for (temp = 1; temp < 4; temp++) {
        if (GET_EQUIPS_BUTTON_ITEMS[temp] > 0xF0) {
            if (temp == 1) {
                gDPSetPrimColor(OVERLAY_DISP++, 0, 0, R_C_BTN_COLOR(0), R_C_BTN_COLOR(1), R_C_BTN_COLOR(2),
                                interfaceCtx->cLeftAlpha);
            } else if (temp == 2) {
...
void Interface_DrawAmmoCount(PlayState* play, s16 button, s16 alpha) {
    ...
    i = GET_EQUIPS_BUTTON_ITEMS[button];
    ...
    if ((i == ITEM_STICK) || (i == ITEM_NUT) || (i == ITEM_BOMB) || (i == ITEM_BOW) ||
        ...
        if ((button == 0) && (GET_MINIGAME_STATE == 1)) {
...
void Interface_Draw(PlayState* play) {
    ...
    if (pauseCtx->debugState == 0) {
        ...
        if (GET_EQUIPS_BUTTON_ITEMS[1] < 0xF0) {
        ...
        if (GET_EQUIPS_BUTTON_ITEMS[2] < 0xF0) {
        ...
        if (GET_EQUIPS_BUTTON_ITEMS[3] < 0xF0) {
        ...
        if ((GET_TIMER2_STATE == 5) && (Message_GetState(&play->msgCtx) == TEXT_STATE_EVENT)) {
            ...
            for (svar1 = 0; svar1 < ARRAY_COUNT(gSpoilingItems); svar1++) {
                if (INV_CONTENT(ITEM_TRADE_ADULT) == gSpoilingItems[svar1]) {
                    ...
                    for (svar2 = 1; svar2 < 4; svar2++) {
                        if (GET_EQUIPS_BUTTON_ITEMS[svar2] == gSpoilingItems[svar1]) {
                            GET_EQUIPS_BUTTON_ITEMS[svar2] = gSpoilingItemReverts[svar1];
        ...
        if ((play->pauseCtx.state == 0) && (play->pauseCtx.debugState == 0) &&
            ...
            (play->transitionMode == TRANS_MODE_OFF) && !Play_InCsMode(play) && (GET_MINIGAME_STATE != 1) &&
            (play->shootingGalleryStatus <= 1) && !((play->sceneId == SCENE_BOWLING) && Flags_GetSwitch(play, 0x38))) {
            svar6 = 0;
            switch (GET_TIMER1_STATE) {
                case 1:
                    D_8015FFE2 = 20;
                    D_8015FFE0 = 20;
                    SET_TIMER1_VALUE(gSaveContext.save.info.playerData.health >> 1)
                    SET_TIMER1_STATE(2)
                    break;
                case 2:
                    D_8015FFE2--;
                ...
                case 3:
                case 7:
                    svar1 = (GET_TIMER_X[0] - 26) / D_8015FFE2;
                    GET_TIMER_X[0] -= svar1;

                    if (GET_HEALTH_CAPACITY > 0xA0) {
                        svar1 = (GET_TIMER_Y[0] - 54) / D_8015FFE2;
                    } else {
                        svar1 = (GET_TIMER_Y[0] - 46) / D_8015FFE2;
                    }
                    GET_TIMER_Y[0] -= svar1;
                ...
                case 4:
                case 8:
                    if ((GET_TIMER1_STATE == 4) || (GET_TIMER1_STATE == 8)) {
                        if (GET_HEALTH_CAPACITY > 0xA0) {
                            GET_TIMER_Y[0] = 54;
                        } else {
                            GET_TIMER_Y[0] = 46;
                    ...
                    if ((GET_TIMER1_STATE >= 3) && (msgCtx->msgLength == 0)) {
                        D_8015FFE0--;
                        if (D_8015FFE0 == 0) {
                            if (GET_TIMER1_VALUE != 0) {
                                GET_TIMER1_VALUE--;
                            }
                    ...
                    switch (GET_TIMER2_STATE) {
                        ...
                        case 9:
                            osSyncPrintf("event_xp[1]=%d,  event_yp[1]=%d  TOTAL_EVENT_TM=%d\n",
                                         (GET_TIMER_X_VOID0[1]), (GET_TIMER_Y_VOID0[1]),
                                         GET_TIMER2_VALUE);
                            svar1 = (GET_TIMER_X[1] - 26) / D_8015FFE6;
                            GET_TIMER_X[1] -= svar1;
                            if (GET_HEALTH_CAPACITY > 0xA0) {
                                svar1 = (GET_TIMER_Y[1] - 54) / D_8015FFE6;
                            } else {
                                svar1 = (GET_TIMER_Y[1] - 46) / D_8015FFE6;
                            }
                            GET_TIMER_Y[1] -= svar1;
                        ...
                        case 4:
                        case 10:
                            if ((GET_TIMER2_STATE == 4) || (GET_TIMER2_STATE == 10)) {
                                if (GET_HEALTH_CAPACITY > 0xA0) {
                                    GET_TIMER_Y[1] = 54;
                                } else {
                                    GET_TIMER_Y[1] = 46;
                            ...
                            if (GET_TIMER2_STATE >= 3) {
                                ...
                                if (D_8015FFE4 == 0) {
                                    D_8015FFE4 = 20;
                                    if (GET_TIMER2_STATE == 4) {
                                        GET_TIMER2_VALUE--;
                                        osSyncPrintf("TOTAL_EVENT_TM=%d\n", GET_TIMER2_VALUE);

                                        if (GET_TIMER2_VALUE <= 0) {
                                        ...
                                        } else if (GET_TIMER2_VALUE > 60) {
                                            if (timerDigits[4] == 1) {
                                                Audio_PlaySfxGeneral(NA_SE_SY_MESSAGE_WOMAN, &gSfxDefaultPos, 4,
                                                                     &gSfxDefaultFreqAndVolScale,
                                                                     &gSfxDefaultFreqAndVolScale, &gSfxDefaultReverb);
                                            }
                                        } else if (GET_TIMER2_VALUE > 10) {
                                            if (timerDigits[4] & 1) {
                                                Audio_PlaySfxGeneral(NA_SE_SY_WARNING_COUNT_N, &gSfxDefaultPos, 4,
                                                                     &gSfxDefaultFreqAndVolScale,
                                                                     &gSfxDefaultFreqAndVolScale, &gSfxDefaultReverb);
            ...
            if (((GET_TIMER1_STATE != 0) && (GET_TIMER1_STATE != 10)) ||
                (GET_TIMER2_STATE != 0)) {
                timerDigits[0] = timerDigits[1] = timerDigits[3] = 0;
                timerDigits[2] = 10; // digit 10 is used as ':' (colon)

                if (GET_TIMER1_STATE != 0) {
                    timerDigits[4] = GET_TIMER1_VALUE;
                } else {
                    timerDigits[4] = GET_TIMER2_VALUE;
                }
                ...
                gDPSetEnvColor(OVERLAY_DISP++, 0, 0, 0, 0);
                OVERLAY_DISP =
                    Gfx_TextureIA8(OVERLAY_DISP, gClockIconTex, 16, 16, (GET_TIMER_X_VOID0[svar6]),
                                   (GET_TIMER_Y_VOID0[svar6]) + 2, 16, 16, 1 << 10, 1 << 10);
                ...
                if (GET_TIMER1_STATE != 0) {
                    if ((GET_TIMER1_VALUE < 10) && (GET_TIMER1_STATE < 11)) {
                        gDPSetPrimColor(OVERLAY_DISP++, 0, 0, 255, 50, 0, 255);
                    } else {
                        gDPSetPrimColor(OVERLAY_DISP++, 0, 0, 255, 255, 255, 255);
                    }
                } else {
                    if ((GET_TIMER2_VALUE < 10) && (GET_TIMER2_STATE < 6)) {
                        gDPSetPrimColor(OVERLAY_DISP++, 0, 0, 255, 50, 0, 255);
                    } else {
                ...
                for (svar1 = 0; svar1 < 5; svar1++) {
                    OVERLAY_DISP =
                        Gfx_TextureI8(OVERLAY_DISP, ((u8*)gCounterDigit0Tex + (8 * 16 * timerDigits[svar1])), 8, 16,
                                      (GET_TIMER_X_VOID0[svar6]) + timerDigitLeftPos[svar1],
                                      (GET_TIMER_Y_VOID0[svar6]), digitWidth[svar1], VREG(42), VREG(43) << 1,
                                      VREG(43) << 1);
                }
            }
        }
...
void Interface_Update(PlayState* play) {
    ...
    if ((play->pauseCtx.state == 0) && (play->pauseCtx.debugState == 0)) {
        if ((GET_MINIGAME_STATE == 1) || !IS_CUTSCENE_LAYER ||
            ((play->sceneId == SCENE_SPOT20) && (GET_SCENE_LAYER == 4))) {
    ...
    if (GET_HEALTH_ACCUMULATOR != 0) {
        GET_HEALTH_ACCUMULATOR -= 4;
        GET_HEALTH += 4;
    ...
    if ((GET_TIMER1_STATE >= 3) && (play->pauseCtx.state == 0) && (play->pauseCtx.debugState == 0) &&
        (msgCtx->msgMode == MSGMODE_NONE) && !(player->stateFlags2 & PLAYER_STATE2_24) &&
        (play->transitionTrigger == TRANS_TRIGGER_OFF) && (play->transitionMode == TRANS_MODE_OFF) &&
        !Play_InCsMode(play)) {}

    if (GET_RUPEE_ACCUMULATOR != 0) {
        if (GET_RUPEE_ACCUMULATOR > 0) {
            if (GET_RUPEES < CUR_CAPACITY(UPG_WALLET)) {
                GET_RUPEE_ACCUMULATOR--;
                GET_RUPEES++;
                ...
                SET_RUPEE_ACCUMULATOR(0)
            }
        } else if (GET_RUPEES != 0) {
            if (GET_RUPEE_ACCUMULATOR <= -50) {
                GET_RUPEE_ACCUMULATOR += 10;
                GET_RUPEES -= 10;
    ...
    if ((play->pauseCtx.state == 0) && (play->pauseCtx.debugState == 0) && (msgCtx->msgMode == MSGMODE_NONE) &&
        ...
        if (GET_IS_MAGIC_ACQUIRED && (GET_MAGIC_LEVEL == 0)) {
            SET_MAGIC_LEVEL(gSaveContext.save.info.playerData.isDoubleMagicAcquired + 1)
            SET_MAGIC_STATE(MAGIC_STATE_STEP_CAPACITY)
            osSyncPrintf(VT_FGCOL(YELLOW));
    ...
    if (GET_TIMER1_STATE == 0) {
        ...
        if (((D_80125A58 == 0) || (D_80125A58 == 3)) && (GET_TIMER1_STATE < 5)) {
            SET_TIMER1_STATE(0)
        }
    }

    if (GET_MINIGAME_STATE == 1) {
        GET_MINIGAME_SCORE += interfaceCtx->unk_23C;
        interfaceCtx->unk_23C = 0;

        if (sHBAScoreTier == 0) {
            if (GET_MINIGAME_SCORE >= 1000) {
                sHBAScoreTier++;
            }
        } else if (sHBAScoreTier == 1) {
            if (GET_MINIGAME_SCORE >= 1500) {
                sHBAScoreTier++;
            }
        }
        ...
        sHBAScoreDigits[2] = 0;
        sHBAScoreDigits[3] = GET_MINIGAME_SCORE;
    ...
    if (GET_SUNS_SONG_STATE != SUNSSONG_INACTIVE) {
        ...
        if ((msgCtx->ocarinaAction != OCARINA_ACTION_CHECK_NOWARP_DONE) &&
            (GET_SUNS_SONG_STATE == SUNSSONG_START)) {
            play->msgCtx.ocarinaMode = OCARINA_MODE_04;
        }

        // handle suns song in areas where time moves
        if (play->envCtx.sceneTimeSpeed != 0) {
            if (GET_SUNS_SONG_STATE != SUNSSONG_SPEED_TIME) {
                D_80125B60 = false;
                if ((GET_DAY_TIME >= CLOCK_TIME(6, 30)) &&
                    (GET_DAY_TIME <= CLOCK_TIME(18, 0) + 1)) {
                    D_80125B60 = true;
                }

                SET_SUNS_SONG_STATE(SUNSSONG_SPEED_TIME)
            ...
            } else if (GET_DAY_TIME > CLOCK_TIME(18, 0) + 1) {
                SET_SUNS_SONG_STATE(SUNSSONG_INACTIVE)
                gTimeSpeed = sPrevTimeSpeed;
                play->msgCtx.ocarinaMode = OCARINA_MODE_04;
            }
            ...
            if ((GET_DAY_TIME >= CLOCK_TIME(6, 30)) &&
                (GET_DAY_TIME < CLOCK_TIME(18, 0) + 1)) {
                SET_NEXT_DAY_TIME(NEXT_TIME_NIGHT)
                play->transitionType = TRANS_TYPE_FADE_BLACK_FAST;
                SET_NEXT_TRANSITION_TYPE(TRANS_TYPE_FADE_BLACK)
                play->unk_11DE9 = true;
            } else {
                SET_NEXT_DAY_TIME(NEXT_TIME_DAY)
            ...
            if (play->sceneId == SCENE_SPOT13) {
                ...
                SET_NEXT_TRANSITION_TYPE(TRANS_TYPE_SANDSTORM_PERSIST)
            }

            SET_RESPAWN_FLAG(-2)
            play->nextEntranceIndex = GET_ENTRANCE_INDEX;
            play->transitionTrigger = TRANS_TRIGGER_START;
            SET_SUNS_SONG_STATE(SUNSSONG_INACTIVE)
            func_800F6964(30);
            ...
            SET_SUNS_SONG_STATE(SUNSSONG_SPECIAL)
        }
    }
}
