...
void Gameplay_Destroy(GlobalContext* globalCtx) {
    ...
    func_8005D400(globalCtx, &globalCtx->colliderCtx);
...
void Gameplay_Init(GlobalContext* globalCtx) {
    ...
    func_8005D3BC(globalCtx, &globalCtx->colliderCtx);
        ...
        if (1 && (gTrnsnUnkState != 3)) {
            ...
            if ((sp80 == 0) && (IREG(72) == 0)) {
                ...
                if ((globalCtx->actorCtx.unk_00 != 0) && (globalCtx->actorCtx.unk_00-- < 5)) {
                    ...
                    Collider_DoATVsAC(globalCtx, &globalCtx->colliderCtx);

                    if (1 && HREG(63)) {
                        LOG_NUM("1", 1, "../z_play.c", 3618);
                    }

                    Collider_DoOCVsOC(globalCtx, &globalCtx->colliderCtx);

                    if (1 && HREG(63)) {
                        LOG_NUM("1", 1, "../z_play.c", 3624);
                    }

                    func_800622E4(globalCtx, &globalCtx->colliderCtx);
