...
void TransitionFade_Update(void* thisx, s32 updateRate) {
    ...
    switch (this->fadeType) {
        ...
        case 1:
            ...
            if (this->fadeTimer >= GET_TRANSFADEDURATION) {
                this->fadeTimer = GET_TRANSFADEDURATION;
                this->isDone = true;
            }
            if (!GET_TRANSFADEDURATION) {
            ...
            alpha = (255.0f * this->fadeTimer) / (GET_TRANSFADEDURATION_VOID0);
