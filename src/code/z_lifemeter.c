...
u32 Health_IsCritical(void) {
    ...
    if (GET_HEALTHCAPACITY <= 0x50) {
        criticalHealth = 0x10;
    } else if (GET_HEALTHCAPACITY <= 0xA0) {
        criticalHealth = 0x18;
    } else if (GET_HEALTHCAPACITY <= 0xF0) {
        criticalHealth = 0x20;
    } else {
        criticalHealth = 0x2C;
    }
