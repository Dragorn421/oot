...
void Collider_WaterBlood(GlobalContext* globalCtx, Collider* collider, Vec3f* arg2) {
    EffectSsSibuki_SpawnBurst(globalCtx, arg2);
...
void func_8005E2EC(GlobalContext* globalCtx, ColliderElement* arg1, Collider* collider, Vec3f* arg3) {
    if (((arg1->atElemFlags & ATELEM_SFX_MASK) == ATELEM_SFX_NORMAL) && (collider->colMaterial != COL_MATERIAL_METAL)) {
        ...
        if (collider->actor == NULL) {
            ...
            Audio_PlaySoundGeneral(NA_SE_IT_SHIELD_BOUND, &collider->actor->projectedPos, 4U, &D_801333E0, &D_801333E0,
                                   &D_801333E8);
        }
        ...
        if (collider->actor == NULL) {
            ...
            Audio_PlaySoundGeneral(NA_SE_IT_REFLECTION_WOOD, &collider->actor->projectedPos, 4U, &D_801333E0,
...
s32 func_8005E4F8(Collider* collider, ColliderElement* arg1) {
    ...
    if ((actor != NULL) && (actor->type == ACTORTYPE_PLAYER)) {
        if (arg1->elemMaterial == 0) {
            Audio_PlaySoundGeneral(NA_SE_IT_SWORD_STRIKE, &actor->projectedPos, 4U, &D_801333E0, &D_801333E0,
                                   &D_801333E8);
        } else if (arg1->elemMaterial == 1) {
            Audio_PlaySoundGeneral(NA_SE_IT_SWORD_STRIKE_HARD, &actor->projectedPos, 4U, &D_801333E0, &D_801333E0,
                                   &D_801333E8);
        } else if (arg1->elemMaterial == 2) {
            Audio_PlaySoundGeneral(0, &actor->projectedPos, 4U, &D_801333E0, &D_801333E0, &D_801333E8);
        ...
        if (acCollider->actor != NULL) {
            if (sHitInfo[acCollider->colMaterial].effect == 3) {
                ...
                if (atCollider->actor == NULL) {
                    ...
                    func_80062E14(globalCtx, arg5, &atCollider->actor->projectedPos);
                }
            } else if (sHitInfo[acCollider->colMaterial].effect != 5) {
                EffectSsHitMark_SpawnFixedScale(globalCtx, sHitInfo[acCollider->colMaterial].effect, arg5);
                if (!(acElem->acElemFlags & ACELEM_NO_SWORD_SFX)) {
                    func_8005E4F8(atCollider, acElem);
                }
            }
        } else {
            EffectSsHitMark_SpawnFixedScale(globalCtx, 0U, arg5);
            if (acCollider->actor == NULL) {
                Audio_PlaySoundGeneral(NA_SE_IT_SHIELD_BOUND, &D_801333D4, 4U, &D_801333E0, &D_801333E0, &D_801333E8);
            } else {
                Audio_PlaySoundGeneral(NA_SE_IT_SHIELD_BOUND, &acCollider->actor->projectedPos, 4U, &D_801333E0,
                                       &D_801333E0, &D_801333E8);
            }
        }
    }
...
void func_80062B80(GlobalContext* globalCtx, Vec3f* arg1) {
    ...
    D_8015D3D8.uDiv = 5;
    D_8015D3D8.vDiv = 5;
    D_8015D3D8.unk49C[0].r = 255;
    D_8015D3D8.unk49C[0].g = 255;
    D_8015D3D8.unk49C[0].b = 255;
    D_8015D3D8.unk49C[0].a = 255;
    D_8015D3D8.unk49C[1].r = 100;
    D_8015D3D8.unk49C[1].g = 100;
    D_8015D3D8.unk49C[1].b = 100;
    D_8015D3D8.unk49C[1].a = 100;
    D_8015D3D8.unk49C[2].r = 100;
    D_8015D3D8.unk49C[2].g = 100;
    D_8015D3D8.unk49C[2].b = 100;
    D_8015D3D8.unk49C[2].a = 100;
    D_8015D3D8.unk49C[3].r = 100;
    D_8015D3D8.unk49C[3].g = 100;
    D_8015D3D8.unk49C[3].b = 100;
    D_8015D3D8.unk49C[3].a = 100;
    D_8015D3D8.unk4AC[0].r = 50;
    D_8015D3D8.unk4AC[0].g = 50;
    D_8015D3D8.unk4AC[0].b = 50;
    D_8015D3D8.unk4AC[0].a = 50;
    D_8015D3D8.unk4AC[1].r = 50;
    D_8015D3D8.unk4AC[1].g = 50;
    D_8015D3D8.unk4AC[1].b = 50;
    D_8015D3D8.unk4AC[1].a = 50;
    D_8015D3D8.unk4AC[2].r = 50;
    D_8015D3D8.unk4AC[2].g = 50;
    D_8015D3D8.unk4AC[2].b = 50;
    D_8015D3D8.unk4AC[2].a = 50;
